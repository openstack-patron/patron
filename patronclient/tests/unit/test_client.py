...
class ClientTest(utils.TestCase):
    ...
    def test_client_with_timeout(self):
        instance = patronclient.client.HTTPClient(user='user',
                                                password='password',
                                                projectid='project',
                                                timeout=2,
    ...
    def test_client_reauth(self):
        ...
        mock_request = mock.Mock()
        mock_request.side_effect = patronclient.exceptions.Unauthorized(401)
        with mock.patch('requests.request', mock_request):
            try:
            ...
            get_headers = {'X-Auth-Project-Id': 'project',
                           'X-Auth-Token': 'foobar',
                           'User-Agent': 'python-patronclient',
    ...
    @mock.patch.object(patronclient.client.HTTPClient, 'request',
    ...
    def test_client_version_url_with_project_name(self):
        self._check_version_url('http://foo.com/patron/v2/%s',
                                'http://foo.com/patron/')

    def test_get_client_class_v3(self):
        output = patronclient.client.get_client_class('3')
        self.assertEqual(output, patronclient.v2.client.Client)

    def test_get_client_class_v2(self):
        output = patronclient.client.get_client_class('2')
        self.assertEqual(output, patronclient.v2.client.Client)
    ...
    def test_get_client_class_v1_1(self):
        output = patronclient.client.get_client_class('1.1')
        self.assertEqual(output, patronclient.v2.client.Client)

    def test_get_client_class_unknown(self):
        self.assertRaises(patronclient.exceptions.UnsupportedVersion,
                          patronclient.client.get_client_class, '0')

    def test_client_with_os_cache_enabled(self):
        cs = patronclient.v2.client.Client("user", "password", "project_id",
    ...
    @mock.patch('patronclient.client.HTTPClient')
    def test_contextmanager_v1_1(self, mock_http_client):
        fake_client = mock.Mock()
        mock_http_client.return_value = fake_client
        with patronclient.v2.client.Client("user", "password", "project_id",
                                         auth_url="foo/v2"):
            pass
    ...
    def test_get_password_simple(self):
        cs = patronclient.client.HTTPClient("user", "password", "", "")
    ...
    def test_get_password_none(self):
        cs = patronclient.client.HTTPClient("user", None, "", "")
    ...
    def test_auth_url_rstrip_slash(self):
        cs = patronclient.client.HTTPClient("user", "password", "project_id",
                                          auth_url="foo/v2/")
        self.assertEqual("foo/v2", cs.auth_url)

    def test_token_and_bypass_url(self):
        cs = patronclient.client.HTTPClient(None, None, None,
                                          auth_token="12345",
    ...
    @mock.patch("patronclient.client.requests.Session")
    ...
    @mock.patch("patronclient.client.requests.Session")
    @mock.patch("patronclient.client._ClientConnectionPool")
