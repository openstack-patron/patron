...
from patronclient.tests.unit.fixture_data import floatingips
from patronclient.tests.unit.fixture_data import servers as data
...
class ServersTest(utils.FixturedTestCase):
    ...
    #
    # RSA Private Key: patronclient/tests/unit/idfake.pem
    #
    # Encrypted password
    ...
    def test_get_password(self):
        ...
        self.assertEqual(b'FooBar123',
                         s.get_password('patronclient/tests/unit/idfake.pem'))
    ...
    def test_interface_list_result_string_representable(self):
        """Test for bugs.launchpad.net/python-patronclient/+bug/1280453."""
        # According to https://github.com/openstack/patron/blob/master/
        # patron/api/openstack/compute/contrib/attach_interfaces.py#L33,
        ...
        # patronclient.base.Manager._list()
