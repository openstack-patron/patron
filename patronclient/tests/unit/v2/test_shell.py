...
import patronclient.client
from patronclient import exceptions
import patronclient.shell
from patronclient.tests.unit import utils
from patronclient.tests.unit.v2 import fakes
import patronclient.v2.shell


class ShellFixture(fixtures.Fixture):
    def setUp(self):
        super(ShellFixture, self).setUp()
        self.shell = patronclient.shell.OpenStackComputeShell()
...
class ShellTest(utils.TestCase):
    FAKE_ENV = {
        ...
        'PATRON_PROJECT_ID': 'project_id',
        'OS_COMPUTE_API_VERSION': '2',
        'PATRON_URL': 'http://no.where',
    ...
    def setUp(self):
        ...
        self.useFixture(fixtures.MonkeyPatch(
            'patronclient.client.get_client_class',
    ...
    @mock.patch('patronclient.v2.shell._poll_for_status')
    ...
    def test_list_sortby_index_with_sort(self):
        ...
        for cmd in ['list --sort key',
            ...
            with mock.patch('patronclient.utils.print_list') as mock_print_list:
                self.run_command(cmd)
    ...
    @mock.patch('patronclient.v2.shell.utils.print_dict')
    ...
    def test_aggregate_create(self):
        self.run_command('aggregate-create test_name patron1')
        body = {"aggregate": {"name": "test_name",
                              "availability_zone": "patron1"}}
    ...
    def test_services_list_with_binary(self):
        self.run_command('service-list --binary patron-cert')
        self.assert_called('GET', '/os-services?binary=patron-cert')

    def test_services_list_with_host_binary(self):
        self.run_command('service-list --host host1 --binary patron-cert')
        self.assert_called('GET', '/os-services?host=host1&binary=patron-cert')

    def test_services_enable(self):
        self.run_command('service-enable host1 patron-cert')
        body = {'host': 'host1', 'binary': 'patron-cert'}
        self.assert_called('PUT', '/os-services/enable', body)

    def test_services_disable(self):
        self.run_command('service-disable host1 patron-cert')
        body = {'host': 'host1', 'binary': 'patron-cert'}
        self.assert_called('PUT', '/os-services/disable', body)

    def test_services_disable_with_reason(self):
        self.run_command('service-disable host1 patron-cert --reason no_reason')
        body = {'host': 'host1', 'binary': 'patron-cert',
    ...
    def test_host_list_with_zone(self):
        self.run_command('host-list --zone patron')
        self.assert_called('GET', '/os-hosts?zone=patron')
    ...
    @mock.patch('patronclient.v2.shell._find_server')
...
class GetSecgroupTest(utils.TestCase):
    def test_with_integer(self):
        ...
        result = patronclient.v2.shell._get_secgroup(cs, '1')
    ...
    def test_with_uuid(self):
        ...
        result = patronclient.v2.shell._get_secgroup(
    ...
    def test_with_an_nonexisting_name(self):
        ...
        self.assertRaises(exceptions.CommandError,
                          patronclient.v2.shell._get_secgroup,
                          cs,
                          'abc')
...
class GetFirstEndpointTest(utils.TestCase):
    def test_only_one_endpoint(self):
        ...
        endpoint = {"url": "test"}
        result = patronclient.v2.shell._get_first_endpoint([endpoint], "XYZ")
    ...
    def test_multiple_endpoints(self):
        ...
        result = patronclient.v2.shell._get_first_endpoint(endpoints, "ORD")
    ...
    def test_multiple_endpoints_but_none_suitable(self):
        ...
        self.assertRaises(LookupError,
                          patronclient.v2.shell._get_first_endpoint,
                          endpoints, "ORD")
