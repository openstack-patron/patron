...
from patronclient import client as base_client
from patronclient import exceptions
from patronclient.tests.unit import fakes
from patronclient.tests.unit import utils
from patronclient.v2 import client
...
class FakeHTTPClient(base_client.HTTPClient):
    ...
    def get_os_services(self, **kw):
        ...
        binary = kw.get('binary', 'patron-compute')
    ...
    def get_os_hosts(self, **kw):
        zone = kw.get('zone', 'patron1')
        return (200, {}, {'hosts': [{'host': 'host1',
                                     'service': 'patron-compute',
                                     'zone': zone},
                                    {'host': 'host1',
                                     'service': 'patron-cert',
                                     'zone': zone}]})
