...
from patronclient.tests.unit.fixture_data import aggregates as data
...
class AggregatesTest(utils.FixturedTestCase):
    ...
    def test_create_aggregate(self):
        body = {"aggregate": {"name": "test", "availability_zone": "patron1"}}
        aggregate = self.cs.aggregates.create("test", "patron1")
