...
from patronclient.tests.unit.fixture_data import availability_zones as data
...
class AvailabilityZoneTest(utils.FixturedTestCase):
    ...
    from patronclient.v2 import shell  # noqa
