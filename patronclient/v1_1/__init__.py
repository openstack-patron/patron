...
from patronclient import v2

warnings.warn("Module patronclient.v1_1 is deprecated (taken as a basis for "
              "patronclient.v2). "
              "The preferable way to get client class or object you can find "
              "in patronclient.client module.")
...
sys.modules["patronclient.v1_1"] = MovedModule(v2)
