...
from patronclient import service_catalog
...
class SessionClient(adapter.LegacyJsonAdapter):
    ...
    def request(self, url, method, **kwargs):
        ...
        # keystoneclient, where we need to raise the patronclient errors.
...
class HTTPClient(object):
    USER_AGENT = 'python-patronclient'
    ...
    def _cs_request(self, url, method, **kwargs):
        ...
        if url is None:
            ...
            # a patron endpoint directly without "v2/<tenant-id>".
...
def _construct_http_client(username=None, password=None, project_id=None,
                           ...
                           auth=None, user_agent='python-patronclient',
