...
wsgi_opts = [
    cfg.StrOpt('api_paste_config',
               ...
               help='File name for the paste.deploy config for patron-api'),
...
class Server(object):
    ...
    def __init__(self, name, app, host='0.0.0.0', port=0, pool_size=None,
        ...
        :returns: None
        :raises: patron.exception.InvalidInput
        """
        ...
        self._logger = logging.getLogger("patron.%s.wsgi.server" % self.name)
...
class Application(object):
    ...
    def factory(cls, global_config, **local_config):
        ...
        A hypothetical configuration would look like:
            ...
            [app:wadl]
            latest_version = 1.3
            paste.app_factory = patron.api.fancy_api:Wadl.factory

        which would result in a call to the `Wadl` class as

            import patron.api.fancy_api
...
class Middleware(Application):
    ...
    def factory(cls, global_config, **local_config):
        ...
        A hypothetical configuration would look like:
            ...
            paste.filter_factory = patron.api.analytics:Analytics.factory

        which would result in a call to the `Analytics` class as

            import patron.api.analytics
...
class Loader(object):
    ...
    def load_app(self, name):
        ...
        :raises: `patron.exception.PasteAppNotFound`
