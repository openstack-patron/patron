...
# collisions with use of 'from patron.compute import <foo>' elsewhere.
import patron.cells.opts
import patron.exception


CELL_TYPE_TO_CLS_NAME = {'api': 'patron.compute.cells_api.ComputeCellsAPI',
                         'compute': 'patron.compute.api.API',
                         None: 'patron.compute.api.API',
                        }


def _get_compute_api_class_name():
    """Returns the name of compute API class."""
    cell_type = patron.cells.opts.get_cell_type()
