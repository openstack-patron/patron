...
from patron.cells import opts as cells_opts
from patron.compute import flavors
from patron.compute import instance_actions
...
from patron.network.security_group import security_group_base
from patron import notifications
...
from patron.objects import keypair as keypair_obj
from patron.objects import quotas as quotas_obj
from patron.objects import security_group as security_group_obj
from patron.pci import request as pci_request
import patron.policy
...
compute_opts = [
    ...
    cfg.IntOpt('max_local_block_devices',
               ...
               help='Maximum number of devices that will result '
                    ...
                    'Setting this to 0 means patron will allow only '
...
def check_policy(context, action, target, scope='compute'):
    ...
    patron.policy.enforce(context, _action, target)
...
class API(base.Base):
    ...
    def _handle_kernel_and_ramdisk(self, context, kernel_id, ramdisk_id,
        ...
        if kernel_id is not None:
            ...
            # Image object and hide all of that stuff within patron.image.api.
        ...
        try:
            ...
            try:
                ...
                if not is_local_delete:
                    ...
                    # https://bugs.launchpad.net/patron/+bug/1333145
    ...
    def _create_reservations(self, context, instance, original_task_state,
        ...
        # see https://bugs.launchpad.net/patron/+bug/1099729 for more details
    ...
    def _local_delete(self, context, instance, bdms, delete_type, cb):
        ...
        if self.cell_type != 'api':
            # NOTE(liusheng): In patron-network multi_host scenario,deleting
    ...
    def backup(self, context, instance, name, backup_type, rotation,
        ...
        # to the backup_instance() method in patron/cells/messaging.py
    ...
    def snapshot(self, context, instance, name, extra_properties=None):
        ...
        # NOTE(comstud): Any changes to this method should also be made
        # to the snapshot_instance() method in patron/cells/messaging.py
        ...
        if instance.vm_state == vm_states.ACTIVE:
            try:
                ...
                quiesced = True
                    ...
                    exception.PatronException, NotImplementedError) as err:
...
class SecurityGroupAPI(base.Base, security_group_base.SecurityGroupBase):
    ...
    # The patron security group api does not use a uuid for the id.
    id_is_uuid = False
