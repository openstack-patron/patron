...
The :py:class:`ComputeManager` class is a :py:class:`patron.manager.Manager` that
...
from patron.compute import build_results
from patron.compute import power_state
from patron.compute import resource_tracker
...
from patron import consoleauth
import patron.context
from patron import exception
from patron import hooks
...
from patron.openstack.common import periodic_task
...
from patron.scheduler import rpcapi as scheduler_rpcapi
...
from patron.virt import storage_users
from patron.virt import virtapi
...
interval_opts = [
    ...
    cfg.IntOpt('scheduler_instance_sync_interval',
               ...
               help='Waiting time interval (seconds) between sending the '
                    ...
                    'that its view of instances is in sync with patron. If the '
...
CONF.import_opt('console_topic', 'patron.console.rpcapi')
CONF.import_opt('host', 'patron.netconf')
CONF.import_opt('my_ip', 'patron.netconf')
CONF.import_opt('vnc_enabled', 'patron.vnc')
CONF.import_opt('enabled', 'patron.spice', group='spice')
CONF.import_opt('enable', 'patron.cells.opts', group='cells')
CONF.import_opt('image_cache_manager_interval', 'patron.virt.imagecache')
CONF.import_opt('enabled', 'patron.rdp', group='rdp')
CONF.import_opt('html5_proxy_base_url', 'patron.rdp', group='rdp')
CONF.import_opt('enabled', 'patron.console.serial', group='serial_console')
CONF.import_opt('base_url', 'patron.console.serial', group='serial_console')
CONF.import_opt('destroy_after_evacuate', 'patron.utils', group='workarounds')
CONF.import_opt('scheduler_tracks_instance_changes',
                'patron.scheduler.host_manager')
...
class InstanceEvents(object):
    ...
    def prepare_for_instance_event(self, instance, event_name):
        ...
        if self._events is None:
            ...
            raise exception.PatronException('In shutdown, no new events '
                                          'can be scheduled')
    ...
    def pop_instance_event(self, instance, event):
        ...
        :param event: the patron.objects.external_event.InstanceExternalEvent
...
class ComputeVirtAPI(virtapi.VirtAPI):
    ...
    def _default_error_callback(self, event_name, instance):
        raise exception.PatronException(_('Instance event failed'))
    ...
    def wait_for_instance_event(self, instance, event_names, deadline=300,
        ...
        status, a PatronException is raised.  If an error_callback is
...
class ComputeManager(manager.Manager):
    ...
    def _destroy_evacuated_instances(self, context):
        ...
        While patron-compute was down, the instances running on it could be
            ...
            if instance.host != our_host:
                ...
                if not CONF.workarounds.destroy_after_evacuate:
                    LOG.warning(_LW('Instance %(uuid)s appears to have been '
                                    ...
                                    'option and restart patron-compute.'),
                                {'uuid': instance.uuid,
                                 'host': instance.host})
                    continue
    ...
    def _init_instance(self, context, instance):
        ...
        if expect_running and CONF.resume_guests_state_on_host_boot:
            LOG.info(_LI('Rebooting instance after patron-compute restart.'),
                     instance=instance)
    ...
    def handle_lifecycle_event(self, event):
        ...
        context = patron.context.get_admin_context(read_deleted='yes')
    ...
    def init_host(self):
        ...
        context = patron.context.get_admin_context()
    ...
    def pre_start_hook(self):
        ...
        """
        self.update_available_resource(patron.context.get_admin_context())
    ...
    def _shutdown_instance(self, context, instance,
        ...
        :param:instance: a patron.objects.Instance object
    ...
    def _delete_instance(self, context, instance, bdms, quotas):
        ...
        :param context: patron request context
        :param instance: patron.objects.instance.Instance object
        :param bdms: patron.objects.block_device.BlockDeviceMappingList object
        :param quotas: patron.objects.quotas.Quotas object
        """
    ...
    def rebuild_instance(self, context, instance, orig_image_ref, image_ref,
        ...
        :param context: `patron.RequestContext` object
        ...
        with self._error_out_instance_on_exception(context, instance):
            ...
            # TODO(jaypipes): Move generate_image_url() into the patron.image.api
    ...
    def snapshot_instance(self, context, image_id, instance):
        ...
        :param context: security context
        :param instance: a patron.objects.instance.Instance object
    ...
    def shelve_offload_instance(self, context, instance, clean_shutdown=True):
        ...
        :param context: request context
        :param instance: patron.objects.instance.Instance
        :param clean_shutdown: give the GuestOS a chance to stop
        """
        self._notify_about_instance_usage(context, instance,
    ...
    def attach_interface(self, context, instance, network_id, port_id,
        ...
        except exception.PatronException as ex:
    ...
    def pre_live_migration(self, context, instance, block_migration, disk,
        ...
        # An example is that patron-instance-instance-xxx,
    ...
    def rollback_live_migration_at_destination(self, context, instance,
        ...
        :param context: security context
        :param instance: a patron.objects.instance.Instance object sent over rpc
        """
        network_info = self._get_instance_nw_info(context, instance)
        self._notify_about_instance_usage(
    ...
    def _sync_instance_power_state(self, context, db_instance, vm_power_state,
        ...
        if self.host != db_instance.host:
            # on the sending end of patron-compute _sync_power_state
            ...
            # on the receiving end of patron-compute, it could happen
    ...
    def _cleanup_running_deleted_instances(self, context):
        ...
        https://bugs.launchpad.net/patron/+bug/911366).
    ...
    def _running_deleted_instances(self, context):
        """Returns a list of instances patron thinks is deleted,
