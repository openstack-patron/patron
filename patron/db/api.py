...
Functions in this module are imported into the patron.db namespace. Call these
functions from patron.db namespace, not the patron.db.api namespace.
...
_BACKEND_MAPPING = {'sqlalchemy': 'patron.db.sqlalchemy.api'}
...
# argument and the RPC to patron-cells.
