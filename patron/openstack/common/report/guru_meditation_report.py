...
For example, in a patron command module (under patron/cmd):
...
from patron.openstack.common.report.generators import conf as cgen
from patron.openstack.common.report.generators import process as prgen
from patron.openstack.common.report.generators import threading as tgen
from patron.openstack.common.report.generators import version as pgen
from patron.openstack.common.report import report
