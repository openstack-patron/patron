...
notify_decorator = 'patron.notifications.notify_decorator'
...
monkey_patch_opts = [
    ...
    cfg.ListOpt('monkey_patch_modules',
                default=[
                  'patron.api.ec2.cloud:%s' % (notify_decorator),
                  'patron.compute.api:%s' % (notify_decorator)
                  ],
...
utils_opts = [
    ...
    cfg.StrOpt('rootwrap_config',
               default="/etc/patron/rootwrap.conf",
...
workarounds_opts = [
    cfg.BoolOpt('disable_rootwrap',
                ...
                help='This option allows a fallback to sudo for performance '
                     ...
                     'https://bugs.launchpad.net/patron/+bug/1415106'),
    cfg.BoolOpt('disable_libvirt_livesnapshot',
                ...
                help='When using libvirt 1.2.2 fails live snapshots '
                     ...
                     'resolved.  See '
                     'https://bugs.launchpad.net/patron/+bug/1334398'),
...
def _get_root_helper():
    if CONF.workarounds.disable_rootwrap:
        ...
        cmd = 'sudo patron-rootwrap %s' % CONF.rootwrap_config
    return cmd
...
def patrondir():
    import patron
    return os.path.abspath(patron.__file__).split('patron/__init__.py')[0]
...
def monkey_patch():
    ...
    Example:
    'patron.api.ec2.cloud:patron.notifications.notify_decorator'

    Parameters of the decorator is as follows.
    (See patron.notifications.notify_decorator)
...
def generate_mac_address():
    ...
    #             properly: 0xfa.
    #             Discussion: https://bugs.launchpad.net/patron/+bug/921838
    mac = [0xfa, 0x16, 0x3e,
...
def is_neutron():
    ...
    try:
        ...
        if cls_name == 'patron.network.quantumv2.api.API':
            cls_name = 'patron.network.neutronv2.api.API'
