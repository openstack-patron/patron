...
from patron.openstack.common import service
...
service_opts = [
    ...
    cfg.StrOpt('metadata_manager',
               default='patron.api.manager.MetadataManager',
    ...
    cfg.StrOpt('compute_manager',
               default='patron.compute.manager.ComputeManager',
               help='Full class name for the Manager for compute'),
    cfg.StrOpt('console_manager',
               default='patron.console.manager.ConsoleProxyManager',
               help='Full class name for the Manager for console proxy'),
    cfg.StrOpt('consoleauth_manager',
               default='patron.consoleauth.manager.ConsoleAuthManager',
               help='Manager for console auth'),
    cfg.StrOpt('cert_manager',
               default='patron.cert.manager.CertManager',
               help='Full class name for the Manager for cert'),
    cfg.StrOpt('network_manager',
               default='patron.network.manager.VlanManager',
               help='Full class name for the Manager for network'),
    cfg.StrOpt('scheduler_manager',
               default='patron.scheduler.manager.SchedulerManager',
...
class Service(service.Service):
    ...
    def create(cls, host=None, binary=None, topic=None, manager=None,
        ...
        :param topic: defaults to bin_name - 'patron-' part
        ...
        if not topic:
            topic = binary.rpartition('patron-')[2]
        if not manager:
            manager_cls = ('%s_manager' %
                           binary.rpartition('patron-')[2])
