...
class FilterSchedulerTestCase(test_scheduler.SchedulerTestCase):
    ...
    @mock.patch('patron.db.instance_extra_get_by_instance_uuid',
    ...
    @mock.patch('patron.scheduler.host_manager.HostManager._add_instance_info')
    @mock.patch('patron.objects.ServiceList.get_by_binary',
                return_value=fakes.SERVICES)
    @mock.patch('patron.objects.ComputeNodeList.get_all',
                return_value=fakes.COMPUTE_NODES)
