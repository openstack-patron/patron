...
from patron.scheduler.client import query as scheduler_query_client
from patron.scheduler.client import report as scheduler_report_client
...
class SchedulerReportClientTestCase(test.NoDBTestCase):
    ...
    @mock.patch('patron.objects.ComputeNode.save')
