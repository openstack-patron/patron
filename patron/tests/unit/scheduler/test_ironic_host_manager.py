...
from patron.scheduler import ironic_host_manager
from patron import test
from patron.tests.unit.scheduler import ironic_fakes
...
class IronicHostManagerTestCase(test.NoDBTestCase):
    ...
    def test_get_all_host_states(self):
        ...
        objects.ServiceList.get_by_binary(
            context, 'patron-compute').AndReturn(ironic_fakes.SERVICES)
