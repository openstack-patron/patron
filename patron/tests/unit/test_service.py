...
from patron.openstack.common import service as _service
...
test_service_opts = [
    cfg.StrOpt("fake_manager",
               default="patron.tests.unit.test_service.FakeManager",
...
class ServiceTestCase(test.TestCase):
    ...
    @mock.patch('patron.servicegroup.API')
    @mock.patch('patron.conductor.api.LocalAPI.service_get_by_host_and_binary')
