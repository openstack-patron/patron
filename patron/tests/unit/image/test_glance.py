...
class TestGlanceClientWrapper(test.NoDBTestCase):
    ...
    @mock.patch('patron.image.glance._create_glance_client')
...
class TestDownloadNoDirectUri(test.NoDBTestCase):
    ...
    @mock.patch('patron.image.glance.GlanceImageService.show')
    ...
    @mock.patch('patron.image.glance.GlanceImageService._get_transfer_module')
    @mock.patch('patron.image.glance.GlanceImageService.show')
...
class TestShow(test.NoDBTestCase):
    ...
    @mock.patch('patron.image.glance._translate_from_glance')
    @mock.patch('patron.image.glance._is_image_available')
    ...
    @mock.patch('patron.image.glance._reraise_translated_image_exception')
    @mock.patch('patron.image.glance._translate_from_glance')
    @mock.patch('patron.image.glance._is_image_available')
...
class TestDetail(test.NoDBTestCase):
    ...
    @mock.patch('patron.image.glance._extract_query_params')
    @mock.patch('patron.image.glance._translate_from_glance')
    @mock.patch('patron.image.glance._is_image_available')
    ...
    @mock.patch('patron.image.glance._reraise_translated_exception')
    @mock.patch('patron.image.glance._extract_query_params')
    @mock.patch('patron.image.glance._translate_from_glance')
    @mock.patch('patron.image.glance._is_image_available')
...
class TestCreate(test.NoDBTestCase):
    ...
    @mock.patch('patron.image.glance._translate_from_glance')
    @mock.patch('patron.image.glance._translate_to_glance')
...
class TestUpdateGlanceImage(test.NoDBTestCase):
    @mock.patch('patron.image.glance.GlanceImageService')
