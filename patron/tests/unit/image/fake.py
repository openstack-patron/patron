...
CONF = cfg.CONF
CONF.import_opt('null_kernel', 'patron.compute.api')
...
def stub_out_image_service(stubs):
    ...
    stubs.Set(patron.image.glance, 'get_remote_image_service',
              lambda x, y: (image_service, y))
    stubs.Set(patron.image.glance, 'get_default_image_service',
