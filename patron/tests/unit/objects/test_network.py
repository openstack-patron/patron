...
class _TestNetworkObject(object):
    ...
    @mock.patch('patron.db.network_get_by_cidr')
    ...
    @mock.patch('patron.db.network_update')
    @mock.patch('patron.db.network_set_host')
    ...
    @mock.patch('patron.db.network_associate')
    ...
    @mock.patch('patron.db.network_create_safe')
    ...
    @mock.patch('patron.db.network_delete_safe')
    ...
    @mock.patch('patron.db.network_get_all_by_uuids')
    ...
    @mock.patch('patron.db.network_get_all_by_host')
    ...
    @mock.patch('patron.db.network_in_use_on_host')
    ...
    @mock.patch('patron.db.project_get_networks')
