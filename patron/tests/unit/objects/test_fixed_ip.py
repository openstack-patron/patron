...
from patron.objects import fixed_ip
...
class _TestFixedIPObject(object):
    ...
    @mock.patch('patron.db.fixed_ip_get_by_floating_address')
    ...
    @mock.patch('patron.db.fixed_ip_get_by_network_host')
    ...
    @mock.patch('patron.db.fixed_ip_associate')
    ...
    @mock.patch('patron.db.fixed_ip_associate_pool')
    ...
    @mock.patch('patron.db.fixed_ip_disassociate_all_by_timeout')
    ...
    @mock.patch('patron.db.fixed_ip_create')
    ...
    @mock.patch('patron.db.fixed_ip_get_all')
    ...
    @mock.patch('patron.db.fixed_ip_get_by_host')
    ...
    @mock.patch('patron.db.fixed_ip_bulk_create')
    ...
    @mock.patch('patron.db.network_get_associated_fixed_ips')
    ...
    def test_backport_default_route(self, mock_get):
        ...
        self.assertIn('default_route', primitive['patron_object.data'])
        fixed_ips[0].obj_make_compatible(primitive['patron_object.data'], '1.1')
        self.assertNotIn('default_route', primitive['patron_object.data'])
