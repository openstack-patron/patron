...
class _LocalTest(_BaseTestCase):
    def setUp(self):
        ...
        # Just in case
        self.useFixture(patron_fixtures.IndirectionAPIFixture(None))
...
class _RemoteTest(_BaseTestCase):
    def _testable_conductor(self):
        ...
        self.useFixture(patron_fixtures.IndirectionAPIFixture(
...
class _TestObject(object):
    ...
    def test_hydration_type_error(self):
        primitive = {'patron_object.name': 'MyObj',
                     'patron_object.namespace': 'patron',
                     'patron_object.version': '1.5',
                     'patron_object.data': {'foo': 'a'}}
    ...
    def test_dehydration(self):
        expected = {'patron_object.name': 'MyObj',
                    'patron_object.namespace': 'patron',
                    'patron_object.version': '1.6',
                    'patron_object.data': {'foo': 1}}
        obj = MyObj(foo=1)
        obj.obj_reset_changes()
    ...
    def test_changes_in_primitive(self):
        ...
        self.assertIn('patron_object.changes', primitive)
    ...
    def test_obj_make_obj_compatible(self):
        ...
        orig_primitive = obj.obj_to_primitive()['patron_object.data']
        ...
        with mock.patch.object(subobj, 'obj_make_compatible') as mock_compat:
            ...
            mock_compat.assert_called_once_with(
                primitive['rel_object']['patron_object.data'], '1.1')
            self.assertEqual('1.1',
                             primitive['rel_object']['patron_object.version'])
    ...
    def test_obj_make_compatible_doesnt_skip_falsey_sub_objects(self):
        ...
        self.assertIn('mylist', primitive['patron_object.data'])
...
class TestObjectSerializer(_BaseTestCase):
    ...
    def test_object_serialization(self):
        ...
        self.assertIn('patron_object.name', primitive)
