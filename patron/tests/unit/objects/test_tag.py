...
from patron.objects import tag
...
class _TestTagObject(object):
    @mock.patch('patron.db.instance_tag_add')
    ...
    @mock.patch('patron.db.instance_tag_delete')
...
class _TestTagList(object):
    ...
    @mock.patch('patron.db.instance_tag_get_by_instance_uuid')
    ...
    @mock.patch('patron.db.instance_tag_set')
    ...
    @mock.patch('patron.db.instance_tag_delete_all')
