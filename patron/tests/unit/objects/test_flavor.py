...
from patron.objects import flavor as flavor_obj
...
class _TestFlavor(object):
    ...
    @mock.patch('patron.db.flavor_access_add')
    @mock.patch('patron.db.flavor_access_remove')
    @mock.patch('patron.db.flavor_extra_specs_delete')
    ...
    @mock.patch('patron.db.flavor_create')
    @mock.patch('patron.db.flavor_extra_specs_delete')
    @mock.patch('patron.db.flavor_extra_specs_update_or_create')
