...
from patron.objects import instance_fault
...
class _TestInstanceFault(object):
    ...
    @mock.patch('patron.cells.rpcapi.CellsAPI.instance_fault_create_at_top')
    @mock.patch('patron.db.instance_fault_create')
