...
from patron.objects import compute_node
from patron.objects import hv_spec
from patron.objects import service
from patron.tests.unit import fake_pci_device_pools
...
class _TestComputeNodeObject(object):
    ...
    @mock.patch('patron.objects.Service.get_by_id')
    @mock.patch('patron.db.compute_nodes_get_by_service_id')
    ...
    @mock.patch('patron.db.compute_node_get_all_by_host')
    ...
    @mock.patch('patron.objects.ComputeNodeList.get_all_by_host')
