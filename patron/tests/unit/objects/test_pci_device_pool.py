...
from patron.tests.unit import fake_pci_device_pools as fake_pci
...
class _TestPciDevicePoolObject(object):
    ...
    def test_obj_make_compatible(self):
        ...
        self.assertIn('numa_node', primitive['patron_object.data'])
        pool_obj.obj_make_compatible(primitive['patron_object.data'], '1.0')
        self.assertNotIn('numa_node', primitive['patron_object.data'])
