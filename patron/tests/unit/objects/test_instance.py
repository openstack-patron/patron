...
from patron.objects import instance
from patron.objects import instance_info_cache
from patron.objects import pci_device
from patron.objects import security_group
...
from patron.tests.unit.objects import test_instance_numa_topology
from patron.tests.unit.objects import test_instance_pci_requests
from patron.tests.unit.objects import test_objects
from patron.tests.unit.objects import test_security_group
...
class _TestInstanceObject(object):
    ...
    def test_datetime_deserialization(self):
        ...
        expected = {'patron_object.name': 'Instance',
                    'patron_object.namespace': 'patron',
                    'patron_object.version': '1.19',
                    'patron_object.data':
                        {'uuid': 'fake-uuid',
                         'launched_at': '1955-11-05T00:00:00Z'},
                    'patron_object.changes': ['launched_at', 'uuid']}
        ...
        expected = {'patron_object.name': 'Instance',
                    ...
                    'patron_object.data':
                        {'uuid': 'fake-uuid',
                         ...
                         'access_ip_v6': '::1'},
                    'patron_object.changes': ['uuid', 'access_ip_v6',
                                            'access_ip_v4']}
        self.assertEqual(primitive, expected)
        inst2 = instance.Instance.obj_from_primitive(primitive)
    ...
    @mock.patch('patron.db.instance_update_and_get_original')
    ...
    @mock.patch('patron.db.instance_extra_update_by_uuid')
    @mock.patch('patron.db.instance_update_and_get_original')
    @mock.patch.object(objects.Instance, '_from_db_object')
    ...
    def test_compat_strings(self):
        ...
        self.assertEqual(expected, primitive['patron_object.data'])
        self.assertEqual('1.6', primitive['patron_object.version'])
    ...
    def test_compat_info_cache(self):
        ...
        self.assertEqual(
            '1.4',
            primitive['patron_object.data']['info_cache']['patron_object.version'])
    ...
    @mock.patch('patron.db.instance_fault_get_by_instance_uuids')
    ...
    def test_backport_flavor(self):
        ...
        self.assertIn('instance_type_id',
                      primitive['patron_object.data']['system_metadata'])
...
class _TestInstanceListObject(object):
    ...
    @mock.patch('patron.objects.instance._expected_cols')
    @mock.patch('patron.db.instance_get_all')
