...
from patron.objects import floating_ip
...
class _TestFloatingIPObject(object):
    ...
    @mock.patch('patron.db.floating_ip_get')
    ...
    @mock.patch('patron.db.floating_ip_allocate_address')
    ...
    @mock.patch('patron.db.floating_ip_fixed_ip_associate')
    ...
    @mock.patch('patron.db.floating_ip_deallocate')
    ...
    @mock.patch('patron.db.floating_ip_destroy')
    ...
    @mock.patch('patron.db.floating_ip_disassociate')
    ...
    @mock.patch('patron.db.floating_ip_get_all')
    ...
    @mock.patch('patron.db.floating_ip_get_all_by_project')
    ...
    @mock.patch('patron.db.floating_ip_get_by_fixed_address')
    ...
    @mock.patch('patron.db.floating_ip_get_by_fixed_ip_id')
    ...
    @mock.patch('patron.db.instance_floating_address_get_all')
    ...
    @mock.patch('patron.db.floating_ip_bulk_create')
    ...
    @mock.patch('patron.db.floating_ip_bulk_destroy')
    ...
    def test_backport_fixedip_1_1(self):
        ...
        self.assertEqual('1.1',
            primitive['patron_object.data']['fixed_ip']['patron_object.version'])
