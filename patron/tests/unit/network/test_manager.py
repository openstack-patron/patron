...
from patron.db.sqlalchemy import models
from patron import exception
from patron import ipv6
from patron.network import floating_ips
from patron.network import linux_net
from patron.network import manager as network_manager
from patron.network import model as net_model
from patron import objects
from patron.objects import network as network_obj
from patron.objects import virtual_interface as vif_obj
from patron import quota
from patron import test
from patron.tests.unit import fake_instance
from patron.tests.unit import fake_ldap
from patron.tests.unit import fake_network
from patron.tests.unit import matchers
from patron.tests.unit.objects import test_fixed_ip
from patron.tests.unit.objects import test_floating_ip
from patron.tests.unit.objects import test_network
from patron.tests.unit.objects import test_service
...
class FlatNetworkTestCase(test.TestCase):
    ...
    @mock.patch('patron.objects.fixed_ip.FixedIPList.get_by_instance_uuid')
    ...
    @mock.patch('patron.objects.instance.Instance.get_by_uuid')
    @mock.patch('patron.objects.quotas.Quotas.reserve')
    @mock.patch('patron.objects.quotas.ids_from_instance')
    ...
    @mock.patch('patron.objects.fixed_ip.FixedIP.get_by_address')
    @mock.patch('patron.objects.quotas.Quotas.reserve')
    @mock.patch('patron.objects.quotas.ids_from_instance')
    ...
    @mock.patch('patron.objects.instance.Instance.get_by_uuid')
    @mock.patch('patron.objects.fixed_ip.FixedIP.associate')
    ...
    @mock.patch('patron.objects.instance.Instance.get_by_uuid')
    @mock.patch('patron.objects.virtual_interface.VirtualInterface'
                '.get_by_instance_and_network')
    @mock.patch('patron.objects.fixed_ip.FixedIP.disassociate')
    @mock.patch('patron.objects.fixed_ip.FixedIP.associate')
    @mock.patch('patron.objects.fixed_ip.FixedIP.save')
    ...
    @mock.patch('patron.objects.virtual_interface.VirtualInterface'
                '.get_by_instance_and_network')
    @mock.patch('patron.objects.fixed_ip.FixedIP.disassociate')
    @mock.patch('patron.objects.fixed_ip.FixedIP.associate_pool')
    @mock.patch('patron.objects.fixed_ip.FixedIP.save')
    @mock.patch('patron.network.manager.NetworkManager._add_virtual_interface')
...
class FlatDHCPNetworkTestCase(test.TestCase):
    ...
    @mock.patch('patron.objects.fixed_ip.FixedIP.get_by_id')
    @mock.patch('patron.objects.floating_ip.FloatingIPList.get_by_host')
    @mock.patch('patron.network.linux_net.iptables_manager._apply')
...
class VlanNetworkTestCase(test.TestCase):
    ...
    @mock.patch('patron.network.manager.VlanManager._setup_network_on_host')
    @mock.patch('patron.network.manager.VlanManager.'
                '_validate_instance_zone_for_dns_domain')
    @mock.patch('patron.network.manager.VlanManager.'
                '_do_trigger_security_group_members_refresh_for_instance')
    @mock.patch('patron.network.manager.VlanManager._add_virtual_interface')
    @mock.patch('patron.objects.instance.Instance.get_by_uuid')
    @mock.patch('patron.objects.fixed_ip.FixedIP.associate')
    @mock.patch('patron.objects.fixed_ip.FixedIP.save')
    @mock.patch('patron.objects.VirtualInterface.get_by_instance_and_network')
    ...
    @mock.patch('patron.db.network_get')
    ...
    @mock.patch('patron.quota.QUOTAS.reserve')
    @mock.patch('patron.quota.QUOTAS.commit')
    ...
    @mock.patch('patron.db.fixed_ip_get')
    ...
    @mock.patch('patron.db.floating_ip_get_all_by_host')
    @mock.patch('patron.db.fixed_ip_get')
    ...
    @mock.patch('patron.db.fixed_ip_get_by_address')
    @mock.patch('patron.db.network_get')
    ...
    @mock.patch('patron.db.fixed_ip_get_by_address')
    @mock.patch('patron.db.network_get')
    @mock.patch('patron.db.fixed_ip_update')
    def test_deallocate_fixed(self, fixed_update, net_get, fixed_get):
        """Verify that release is called properly.

        Ensures https://bugs.launchpad.net/patron/+bug/973442 doesn't return
        """
        net_get.return_value = dict(test_network.fake_network,
                                    **networks[1])
    ...
    @mock.patch('patron.network.linux_net.device_exists', return_value=True)
    def test_deallocate_fixed_with_dhcp(self, mock_dev_exists):
        self._deallocate_fixed_with_dhcp(mock_dev_exists)

    @mock.patch('patron.network.linux_net.device_exists', return_value=False)
    ...
    def test_deallocate_fixed_no_vif(self, fixed_update, net_get, fixed_get):
        ...
        Ensures https://bugs.launchpad.net/patron/+bug/968457 doesn't return
        """
        net_get.return_value = dict(test_network.fake_network,
                                    **networks[1])
...
class CommonNetworkTestCase(test.TestCase):
    ...
    @mock.patch('patron.db.instance_get')
    @mock.patch('patron.db.fixed_ip_get_by_instance')
    ...
    @mock.patch('patron.db.fixed_ip_get_by_instance')
    @mock.patch('patron.db.fixed_ip_disassociate')
    ...
    @mock.patch('patron.db.network_get_all')
    ...
    @mock.patch('patron.db.network_get')
    @mock.patch('patron.db.fixed_ips_by_virtual_interface')
    ...
    @mock.patch('patron.db.network_get_by_uuid')
    ...
    @mock.patch('patron.db.network_get_by_uuid')
    @mock.patch('patron.db.network_disassociate')
    ...
    @mock.patch('patron.objects.quotas.Quotas.rollback')
    @mock.patch('patron.objects.fixed_ip.FixedIP.get_by_address')
    @mock.patch('patron.network.manager.NetworkManager.'
                '_do_trigger_security_group_members_refresh_for_instance')
...
class RPCAllocateTestCase(test.NoDBTestCase):
    """Tests patron.network.manager.RPCAllocateFixedIP."""
    def setUp(self):
...
class AllocateTestCase(test.TestCase):
    ...
    def setUp(self):
        ...
        dns = 'patron.network.noop_dns_driver.NoopDNSDriver'
...
class FloatingIPTestCase(test.TestCase):
    """Tests patron.network.manager.FloatingIP."""
    ...
    @mock.patch('patron.db.fixed_ip_get')
    @mock.patch('patron.db.network_get')
    @mock.patch('patron.db.instance_get_by_uuid')
    @mock.patch('patron.db.service_get_by_host_and_binary')
    @mock.patch('patron.db.floating_ip_get_by_address')
    ...
    @mock.patch('patron.db.fixed_ip_get')
    @mock.patch('patron.db.floating_ip_get_by_address')
    @mock.patch('patron.db.floating_ip_update')
    ...
    @mock.patch('patron.objects.FloatingIP.get_by_address')
    ...
    @mock.patch('patron.objects.FloatingIPList.get_by_project')
    ...
    @mock.patch('patron.objects.FloatingIPList.get_by_fixed_address')
    ...
    @mock.patch('patron.db.floating_ip_get_pools')
...
class InstanceDNSTestCase(test.TestCase):
    """Tests patron.network.manager instance DNS."""
    def setUp(self):
...
class LdapDNSTestCase(test.NoDBTestCase):
    """Tests patron.network.ldapdns.LdapDNS."""
    def setUp(self):
        super(LdapDNSTestCase, self).setUp()

        self.useFixture(fixtures.MonkeyPatch(
            'patron.network.ldapdns.ldap',
            fake_ldap))
        dns_class = 'patron.network.ldapdns.LdapDNS'
