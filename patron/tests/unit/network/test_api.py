...
from patron.network import api
from patron.network import base_api
from patron.network import floating_ips
from patron.network import model as network_model
from patron.network import rpcapi as network_rpcapi
from patron import objects
from patron.objects import fields
...
from patron.tests.unit.objects import test_virtual_interface
...
class ApiTestCase(test.TestCase):
    ...
    @mock.patch('patron.objects.NetworkList.get_all')
    ...
    def test_get_all_liberal(self, mock_get_all):
        self.flags(network_manager='patron.network.manager.FlatDHCPManaager')
        mock_get_all.return_value = mock.sentinel.get_all
        self.assertEqual(mock.sentinel.get_all,
                         self.network_api.get_all(self.context))
        mock_get_all.assert_called_once_with(self.context,
    ...
    @mock.patch('patron.objects.Network.get_by_uuid')
    ...
    @mock.patch('patron.objects.Network.get_by_id')
    @mock.patch('patron.db.virtual_interface_get_by_instance')
    ...
    @mock.patch('patron.objects.Network.get_by_id')
    @mock.patch('patron.db.virtual_interface_get_by_address')
    ...
    @mock.patch('patron.objects.FloatingIP.get_by_id')
    ...
    @mock.patch('patron.objects.FloatingIP.get_pool_names')
    ...
    @mock.patch('patron.objects.Network.get_by_uuid')
    @mock.patch('patron.objects.Network.disassociate')
    ...
    @mock.patch('patron.objects.Network.get_by_uuid')
    @mock.patch('patron.objects.Network.associate')
    ...
    @mock.patch('patron.objects.Network.get_by_uuid')
    @mock.patch('patron.objects.Network.save')
    ...
    @mock.patch('patron.objects.FixedIP.get_by_id')
    ...
    @mock.patch('patron.objects.FixedIP.get_by_floating_address')
    ...
    @mock.patch('patron.network.api.API.migrate_instance_start')
    ...
    @mock.patch('patron.network.api.API.migrate_instance_finish')
...
@mock.patch('patron.network.api.API')
@mock.patch('patron.db.instance_info_cache_update')
