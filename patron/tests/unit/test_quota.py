...
from patron.db.sqlalchemy import api as sqa_api
from patron.db.sqlalchemy import models as sqa_models
...
class QuotaIntegrationTestCase(test.TestCase):
    ...
    def setUp(self):
        ...
        self.flags(compute_driver='patron.virt.fake.FakeDriver',
                   ...
                   network_manager='patron.network.manager.FlatDHCPManager')
...
class QuotaEngineTestCase(test.TestCase):
    ...
    def test_init_override_string(self):
        quota_obj = quota.QuotaEngine(
            quota_driver_class='patron.tests.unit.test_quota.FakeDriver')
...
class QuotaReserveSqlAlchemyTestCase(test.TestCase):
    # patron.db.sqlalchemy.api.quota_reserve is so complex it needs its
