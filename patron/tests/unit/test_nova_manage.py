...
from patron.cmd import manage
from patron import context
from patron import db
from patron.db import migration
from patron.db.sqlalchemy import migration as sqla_migration
...
class FixedIpCommandsTestCase(test.TestCase):
    ...
    def test_list_just_one_host(self):
        ...
        self.useFixture(fixtures.MonkeyPatch(
            'patron.db.fixed_ip_get_by_host',
...
class NetworkCommandsTestCase(test.TestCase):
    ...
    def test_create(self):
        ...
        from patron.network import manager as net_manager
