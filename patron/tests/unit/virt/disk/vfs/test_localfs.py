...
from patron.tests.unit import utils as tests_utils
import patron.utils
...
class VirtDiskVFSLocalFSTest(test.NoDBTestCase):
    def test_makepath(self):
        ...
        root_helper = patron.utils._get_root_helper()
    ...
    @mock.patch.object(patron.utils, 'execute')
    ...
    @mock.patch.object(patron.virt.disk.mount.nbd, 'NbdMount')
