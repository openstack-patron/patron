...
from patron.tests.unit.virt.disk.vfs import fakeguestfs
from patron.virt.disk import api as diskapi
from patron.virt.disk.vfs import guestfs as vfsguestfs
...
class VirtDiskTest(test.NoDBTestCase):
    def setUp(self):
        ...
        self.useFixture(
                fixtures.MonkeyPatch('patron.virt.disk.vfs.guestfs.guestfs',
                                     fakeguestfs))
