...
from patron.virt.disk import api
...
class APITestCase(test.NoDBTestCase):
    def test_can_resize_need_fs_type_specified(self):
        ...
        self.useFixture(fixtures.MonkeyPatch(
                'patron.virt.disk.api.get_disk_size', _fake_get_disk_size))
        ...
        def fake_returns_nothing(*args, **kwargs):
            return ''
        self.useFixture(fixtures.MonkeyPatch(
                'patron.virt.disk.mount.nbd.NbdMount.get_dev',
                fake_returns_true))
        self.useFixture(fixtures.MonkeyPatch(
                'patron.virt.disk.mount.nbd.NbdMount.map_dev',
                fake_returns_true))
        self.useFixture(fixtures.MonkeyPatch(
