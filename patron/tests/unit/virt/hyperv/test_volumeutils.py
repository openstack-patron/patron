...
from patron.tests.unit.virt.hyperv import test_basevolumeutils
from patron.virt.hyperv import vmutils
from patron.virt.hyperv import volumeutils

CONF = cfg.CONF
CONF.import_opt('volume_attach_retry_count', 'patron.virt.hyperv.volumeops',
                'hyperv')
...
class VolumeUtilsTestCase(test_basevolumeutils.BaseVolumeUtilsTestCase):
    ...
    def _test_execute_wrapper(self, raise_exception):
        ...
        with mock.patch('patron.utils.execute') as fake_execute:
