...
from patron.virt.hyperv import livemigrationops
...
class LiveMigrationOpsTestCase(test_base.HyperVBaseTestCase):
    ...
    @mock.patch('patron.virt.hyperv.vmops.VMOps.copy_vm_console_logs')
    @mock.patch('patron.virt.hyperv.vmops.VMOps.copy_vm_dvd_disks')
    ...
    @mock.patch('patron.virt.hyperv.vmops.VMOps.log_vm_serial_output')
