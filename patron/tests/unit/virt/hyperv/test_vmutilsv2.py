...
from patron.tests.unit.virt.hyperv import test_vmutils
...
class VMUtilsV2TestCase(test_vmutils.VMUtilsTestCase):
    ...
    @mock.patch('patron.virt.hyperv.vmutilsv2.VMUtilsV2.check_ret_val')
    @mock.patch('patron.virt.hyperv.vmutilsv2.VMUtilsV2._get_wmi_obj')
