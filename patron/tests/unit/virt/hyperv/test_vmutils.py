...
class VMUtilsTestCase(test.NoDBTestCase):
    ...
    @mock.patch('patron.virt.hyperv.vmutils.VMUtils._get_vm_disks')
    ...
    @mock.patch("patron.virt.hyperv.vmutils.VMUtils.get_attached_disks")
    ...
    @mock.patch("patron.virt.hyperv.vmutils.VMUtils.get_free_controller_slot")
    @mock.patch("patron.virt.hyperv.vmutils.VMUtils._get_vm_scsi_controller")
    ...
    @mock.patch('patron.virt.hyperv.vmutils.VMUtils.check_ret_val')
    ...
    @mock.patch('patron.virt.hyperv.vmutils.VMUtils.check_ret_val')
    @mock.patch('patron.virt.hyperv.vmutils.VMUtils._get_wmi_obj')
    @mock.patch('patron.virt.hyperv.vmutils.VMUtils._modify_virtual_system')
    @mock.patch('patron.virt.hyperv.vmutils.VMUtils._get_vm_setting_data')
