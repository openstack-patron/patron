...
from patron.tests.unit import test_flavors
...
from patron.virt import driver as v_driver
from patron.virt.vmwareapi import constants
from patron.virt.vmwareapi import driver
from patron.virt.vmwareapi import error_util
from patron.virt.vmwareapi import imagecache
from patron.virt.vmwareapi import images
from patron.virt.vmwareapi import vif
...
class VMwareDriverStartupTestCase(test.NoDBTestCase):
    def _start_driver_with_flags(self, expected_exception_type, startup_flags):
        ...
        with mock.patch(
                'patron.virt.vmwareapi.driver.VMwareAPISession.__init__'):
            e = self.assertRaises(
...
class VMwareAPIVMTestCase(test.NoDBTestCase):
    ...
    def test_snapshot_delete_vm_snapshot_exception(self):
        self._snapshot_delete_vm_snapshot_exception(exception.PatronException)
    ...
    def test_spawn_multiple_node(self):
        ...
        self.stubs.Set(patron_utils, 'is_neutron', fake_is_neutron)
