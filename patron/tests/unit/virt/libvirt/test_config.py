...
from patron.virt.libvirt import config
...
class LibvirtConfigGuestConsoleTest(LibvirtConfigBaseTest):
    ...
    def test_config_type_file_with_target_type(self):
        ...
        obj.source_path = "/var/lib/patron/instances/uuid/console.log"

        xml = obj.to_xml()
        self.assertXmlEqual(xml, """
            <console type="file">
                <source path="/var/lib/patron/instances/uuid/console.log"/>
                <target type="sclplm"/>
            </console>
            """)
...
class LibvirtConfigGuestMetadataNovaTest(LibvirtConfigBaseTest):
    ...
    def test_config_metadata(self):
        ...
        xml = meta.to_xml()
        self.assertXmlEqual(xml, """
    <patron:instance xmlns:patron='http://openstack.org/xmlns/libvirt/patron/1.0'>
      <patron:package version="2014.2.3"/>
      <patron:name>moonbuggy</patron:name>
      <patron:creationTime>2009-02-13 23:31:30</patron:creationTime>
      <patron:flavor name="m1.lowgravity">
        <patron:memory>2048</patron:memory>
        <patron:disk>50</patron:disk>
        <patron:swap>10</patron:swap>
        <patron:ephemeral>10</patron:ephemeral>
        <patron:vcpus>8</patron:vcpus>
      </patron:flavor>
      <patron:owner>
        <patron:user
         uuid="3472c2a6-de91-4fb5-b618-42bc781ef670">buzz</patron:user>
        <patron:project
         uuid="f241e906-010e-4917-ae81-53f4fb8aa021">moonshot</patron:project>
      </patron:owner>
      <patron:root type="image" uuid="fe55c69a-8b2e-4bbc-811a-9ad2023a0426"/>
    </patron:instance>
        """)
