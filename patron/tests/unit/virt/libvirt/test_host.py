...
class HostTestCase(test.NoDBTestCase):
    ...
    def test_connect_auth_cb_exception(self, log_mock):
        creds = dict(authname='patron', password='verybadpass')
    ...
    def test_cpu_features_bug_1217630(self):
        ...
        with mock.patch('patron.virt.libvirt.host.libvirt') as mock_libvirt:
    ...
    @mock.patch('patron.virt.libvirt.host.Host.find_secret')
