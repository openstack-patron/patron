...
"""
        ...
        for f in ['raw', 'qcow2']:
            ...
            with mock.patch('patron.utils.execute',
...
cluster_size: 65536
disk size: 963434
backing file: /var/lib/patron/a328c7998805951a_2
"""
        mock_execute.return_value = (example_output, '')
        image_info = images.qemu_img_info(path)
        mock_execute.assert_called_once_with('env', 'LC_ALL=C', 'LANG=C',
        ...
        self.assertEqual(65536, image_info.cluster_size)
        self.assertEqual('/var/lib/patron/a328c7998805951a_2',
...
"""
    ...
    def test_chown_for_id_maps(self, mock_execute):
        ...
        execute_args = ('patron-idmapshift', '-i',
    ...
    @mock.patch('patron.virt.images.fetch_to_raw')
