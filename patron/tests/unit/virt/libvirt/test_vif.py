...
from patron.virt.libvirt import vif
...
class LibvirtVifTestCase(test.NoDBTestCase):
    ...
    def test_model_qemu_no_firewall(self):
        self.flags(firewall_driver="patron.virt.firewall.NoopFirewallDriver")
    ...
    def test_model_qemu_iptables(self):
        self.flags(firewall_driver="patron.virt.firewall.IptablesFirewallDriver")
        self._test_model_qemu(
            self.vif_bridge,
            self.vif_ovs,
            self.vif_ivs,
    ...
    @mock.patch('patron.network.linux_net.device_exists')
    ...
    def test_ivs_plug_with_patron_firewall(self):
        d = vif.LibvirtGenericVIFDriver()
    ...
    def test_ivs_plug_with_port_filter_direct_no_patron_firewall(self):
        d = vif.LibvirtGenericVIFDriver()
    ...
    def test_ivs_plug_with_port_filter_hybrid_no_patron_firewall(self):
        d = vif.LibvirtGenericVIFDriver()
    ...
    def test_hybrid_plug_without_patron_firewall(self):
        d = vif.LibvirtGenericVIFDriver()
    ...
    def test_direct_plug_with_port_filter_cap_no_patron_firewall(self):
        d = vif.LibvirtGenericVIFDriver()
