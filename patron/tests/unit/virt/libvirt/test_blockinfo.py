...
class LibvirtBlockInfoTest(test.NoDBTestCase):
    ...
    @mock.patch('patron.virt.libvirt.blockinfo.find_disk_dev_for_disk_bus',
                return_value='vda')
    @mock.patch('patron.virt.libvirt.blockinfo.get_disk_bus_for_disk_dev',
                return_value='virtio')
...
class DefaultDeviceNamesTestCase(test.NoDBTestCase):
    def setUp(self):
        ...
        self.patchers.append(mock.patch(
                'patron.objects.block_device.BlockDeviceMapping.save'))
