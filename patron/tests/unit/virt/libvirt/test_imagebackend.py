...
from patron.openstack.common import imageutils
...
CONF = cfg.CONF
CONF.import_opt('fixed_key', 'patron.keymgr.conf_key_mgr', group='keymgr')
...
class _ImageTestCase(object):
    ...
    @mock.patch('patron.virt.disk.api.get_disk_size')
