...
from patron.db.sqlalchemy import migrate_repo
from patron.db.sqlalchemy import migration as sa_migration
...
class NovaMigrationsCheckers(test_migrations.ModelsMigrationsSync,
    ...
    def setUp(self):
        ...
        # case and patron base test case cleanup must be the last one (as it
...
class ProjectTestCase(test.NoDBTestCase):
    ...
    def test_all_migrations_have_downgrade(self):
        ...
        py_glob = os.path.join(topdir, "patron", "db", "sqlalchemy",
