...
from patron.compute import resources
...
from patron.tests.unit.compute.monitors import test_monitors
from patron.tests.unit.pci import fakes as pci_fakes
...
class ComputeMonitorTestCase(BaseTestCase):
    def setUp(self):
        ...
        fake_monitors = [
            'patron.tests.unit.compute.monitors.test_monitors.FakeMonitorClass1',
            'patron.tests.unit.compute.monitors.test_monitors.FakeMonitorClass2']
