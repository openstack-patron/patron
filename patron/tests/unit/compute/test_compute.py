...
from patron import block_device
...
from patron.console import type as ctype
...
from patron.objects import block_device as block_device_obj
from patron.objects import instance as instance_obj
from patron import policy
from patron import quota
from patron.scheduler import client as scheduler_client
from patron import test
from patron.tests.unit.compute import eventlet_utils
from patron.tests.unit.compute import fake_resource_tracker
from patron.tests.unit.db import fakes as db_fakes
...
from patron.tests.unit import fake_server_actions
from patron.tests.unit.image import fake as fake_image
from patron.tests.unit import matchers
from patron.tests.unit.objects import test_flavor
from patron.tests.unit.objects import test_migration
...
CONF.import_opt('live_migration_retry_count', 'patron.compute.manager')
CONF.import_opt('default_ephemeral_format', 'patron.virt.driver')
...
class BaseTestCase(test.TestCase):
    ...
    def setUp(self):
        ...
        self.flags(network_manager='patron.network.manager.FlatManager')
...
class ComputeVolumeTestCase(BaseTestCase):
    ...
    @mock.patch.object(patron.virt.block_device, 'get_swap')
    @mock.patch.object(patron.virt.block_device, 'convert_blanks')
    @mock.patch.object(patron.virt.block_device, 'convert_images')
    @mock.patch.object(patron.virt.block_device, 'convert_snapshots')
    @mock.patch.object(patron.virt.block_device, 'convert_volumes')
    @mock.patch.object(patron.virt.block_device, 'convert_ephemerals')
    @mock.patch.object(patron.virt.block_device, 'convert_swap')
    @mock.patch.object(patron.virt.block_device, 'attach_block_devices')
...
class ComputeTestCase(BaseTestCase):
    ...
    def test_wrap_instance_event_log_exception(self, mock_finish, mock_start):
        ...
        self.assertRaises(exception.PatronException, fake_event,
                          self.compute, self.context, instance=inst)

        self.assertTrue(mock_start.called)
        self.assertTrue(mock_finish.called)
        args, kwargs = mock_finish.call_args
        self.assertIsInstance(kwargs['exc_val'], exception.PatronException)
    ...
    def test_run_instance_setup_block_device_mapping_fail(self):
        ...
        self.stubs.Set(patron.compute.manager.ComputeManager,
    ...
    @mock.patch('patron.compute.manager.ComputeManager._prep_block_device',
                side_effect=exception.OverQuota(overs='volumes'))
    ...
    def test_rescue(self):
        ...
        self.stubs.Set(patron.virt.fake.FakeDriver, 'rescue', fake_rescue)

        def fake_unrescue(self, instance_ref, network_info):
            called['unrescued'] = True

        self.stubs.Set(patron.virt.fake.FakeDriver, 'unrescue',
                       fake_unrescue)
    ...
    def test_rescue_handle_err(self):
        ...
        self.mox.StubOutWithMock(patron.virt.fake.FakeDriver, 'rescue')

        self.compute._get_rescue_image(
            mox.IgnoreArg(), inst_obj, mox.IgnoreArg()).AndReturn({})
        patron.virt.fake.FakeDriver.rescue(
    ...
    @mock.patch.object(patron.compute.utils, "get_image_metadata")
    @mock.patch.object(patron.virt.fake.FakeDriver, "rescue")
    ...
    def test_power_on(self):
        ...
        self.stubs.Set(patron.virt.fake.FakeDriver, 'power_on',
    ...
    def test_power_off(self):
        ...
        self.stubs.Set(patron.virt.fake.FakeDriver, 'power_off',
    ...
    def test_inject_network_info(self):
        ...
        self.stubs.Set(patron.virt.fake.FakeDriver, 'inject_network_info',
    ...
    def test_reset_network(self):
        ...
        self.stubs.Set(patron.virt.fake.FakeDriver, 'reset_network',
    ...
    @mock.patch.object(patron.compute.manager.ComputeManager, '_rotate_backups')
    ...
    @mock.patch.object(patron.compute.manager.ComputeManager, '_rotate_backups')
    @mock.patch.object(patron.compute.manager.ComputeManager,
    ...
    def _ensure_quota_reservations_committed(self, instance):
        ...
        self.mox.StubOutWithMock(patron.quota.QUOTAS, 'commit')
        patron.quota.QUOTAS.commit(mox.IgnoreArg(), reservations,
    ...
    def _ensure_quota_reservations_rolledback(self, instance):
        ...
        reservations = list('fake_res')
        self.mox.StubOutWithMock(patron.quota.QUOTAS, 'rollback')
        patron.quota.QUOTAS.rollback(mox.IgnoreArg(), reservations,
                                   project_id=instance['project_id'],
                                   user_id=instance['user_id'])
        self.mox.ReplayAll()
        return reservations
    ...
    def _test_finish_resize(self, power_on):
        ...
        # patron.conf sets the default flavor to m1.small and the test
    ...
    def test_add_instance_fault(self):
        ...
        self.stubs.Set(patron.db, 'instance_fault_create', fake_db_fault_create)
    ...
    @mock.patch('patron.objects.InstanceList.get_by_filters')
    @mock.patch('patron.compute.api.API.unrescue')
...
class ComputeAPITestCase(BaseTestCase):
    ...
    @mock.patch('patron.virt.hardware.numa_get_constraints')
    ...
    def test_check_and_transform_image(self):
        ...
        # is created by patron image-create from a volume backed server
        # see bug 1381598
    ...
    def test_attach_interface_failed(self):
        ...
        with contextlib.nested(
            ...
            mock_attach.side_effect = exception.PatronException("attach_failed")
    ...
    def test_detach_interface_failed(self):
        ...
        with contextlib.nested(
            mock.patch.object(self.compute.driver, 'detach_interface',
                side_effect=exception.PatronException('detach_failed')),
            mock.patch.object(self.compute.network_api,
                              'deallocate_port_for_instance')) as (
...
class ComputeAPIIpFilterTestCase(test.NoDBTestCase):
    ...
    def test_ip_filtering_no_limit_to_db(self):
        ...
        with mock.patch('patron.objects.InstanceList.get_by_filters') as m_get:
...
class ComputeAPIAggrTestCase(BaseTestCase):
    ...
    def test_update_aggregate_az_fails_with_patron_az(self):
        # Ensure aggregate's availability zone can't be updated,
        # when aggregate has hosts in other availability zone
        fake_notifier.NOTIFICATIONS = []
        values = _create_service_entries(self.context)
    ...
    def test_add_host_to_multi_az_with_patron_agg(self):
...
class ComputeAggrTestCase(BaseTestCase):
    """This is for unit coverage of aggregate-related methods
    defined in patron.compute.manager.
    """
...
class ComputePolicyTestCase(BaseTestCase):
    ...
    def test_actions_are_prefixed(self):
        ...
        patron.policy.enforce(self.context, 'compute:reboot', {})
        self.mox.ReplayAll()
