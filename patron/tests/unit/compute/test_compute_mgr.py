...
from patron.tests.unit.objects import test_instance_fault
from patron.tests.unit.objects import test_instance_info_cache
from patron import utils
from patron.virt import driver as virt_driver
...
class ComputeManagerUnitTestCase(test.NoDBTestCase):
    ...
    @mock.patch('patron.utils.spawn_n')
    @mock.patch('patron.compute.manager.ComputeManager.'
    ...
    @mock.patch('patron.objects.InstanceList')
    ...
    def test_init_instance_resets_crashed_live_migration(self):
        ...
        with contextlib.nested(
            ...
            mock.patch('patron.compute.utils.get_nw_info_for_instance',
                       return_value=network_model.NetworkInfo())
        ) as (save, get_nw_info):
            self.compute._init_instance(self.context, instance)
    ...
    @mock.patch('patron.compute.manager.ComputeManager._get_power_state',
    ...
    @mock.patch('patron.compute.manager.ComputeManager.unpause_instance')
    ...
    @mock.patch('patron.context.RequestContext.elevated')
    @mock.patch('patron.compute.utils.get_nw_info_for_instance')
    @mock.patch(
        'patron.compute.manager.ComputeManager._get_instance_block_device_info')
    @mock.patch('patron.virt.driver.ComputeDriver.destroy')
    @mock.patch('patron.virt.driver.ComputeDriver.get_volume_connector')
    ...
    @mock.patch('patron.virt.driver.ComputeDriver.list_instance_uuids')
    @mock.patch('patron.db.api.instance_get_all_by_filters')
    ...
    @mock.patch('patron.compute.manager.InstanceEvents._lock_name')
    ...
    @mock.patch('patron.objects.BlockDeviceMapping.get_by_volume_id')
    @mock.patch('patron.compute.manager.ComputeManager._detach_volume')
    @mock.patch('patron.objects.Instance._from_db_object')
    ...
    @mock.patch('patron.compute.manager.ComputeManager._get_power_state',
                return_value=power_state.RUNNING)
    @mock.patch.object(objects.Instance, 'save')
    @mock.patch('patron.utils.generate_password', return_value='fake-pass')
    ...
    @mock.patch('patron.compute.manager.ComputeManager._get_power_state',
                return_value=power_state.RUNNING)
    @mock.patch('patron.compute.manager.ComputeManager._instance_update')
    @mock.patch.object(objects.Instance, 'save')
    @mock.patch.object(compute_utils, 'add_instance_fault_from_exc')
    ...
    @mock.patch('patron.compute.manager.ComputeManager._get_instances_on_driver')
    ...
    @mock.patch('patron.compute.manager.ComputeManager.'
                '_destroy_evacuated_instances')
    @mock.patch('patron.compute.manager.LOG')
    ...
    @mock.patch.object(patron.scheduler.client.SchedulerClient,
    ...
    @mock.patch.object(patron.context.RequestContext, 'elevated')
    @mock.patch.object(patron.objects.InstanceList, 'get_by_host')
    @mock.patch.object(patron.scheduler.client.SchedulerClient,
                       'sync_instance_info')
...
class ComputeManagerBuildInstanceTestCase(test.NoDBTestCase):
    ...
    @mock.patch('patron.hooks._HOOKS')
    @mock.patch('patron.utils.spawn_n')
    ...
    @mock.patch('patron.objects.Instance.save')
    @mock.patch('patron.compute.manager.ComputeManager._build_and_run_instance')
    @mock.patch('patron.utils.spawn_n')
    ...
    def test_rescheduled_exception_with_non_ascii_exception(self):
        exc = exception.PatronException(u's\xe9quence')
    ...
    @mock.patch('patron.network.model.NetworkInfoAsyncWrapper.wait')
    @mock.patch(
        'patron.compute.manager.ComputeManager._build_networks_for_instance')
    @mock.patch('patron.objects.Instance.save')
