...
"""
Unit Tests for patron.compute.rpcapi
"""
...
from patron.objects import block_device as objects_block_dev
from patron.objects import compute_node as objects_compute_node
from patron.objects import network_request as objects_network_request
from patron.objects import numa as objects_numa
...
class ComputeRpcAPITestCase(test.NoDBTestCase):
    ...
    def _test_compute_api(self, method, rpc_method,
        ...
        patron_network = kwargs.pop('patron_network', False)
    ...
    @mock.patch('patron.compute.rpcapi.ComputeAPI._warn_buggy_live_migrations')
    ...
    def test_build_and_run_instance_icehouse_compat_patron_net(self, is_neutron):
        self.flags(compute='icehouse', group='upgrade_levels')
        self._test_compute_api('build_and_run_instance', 'cast',
                instance=self.fake_instance_obj, host='host', image='image',
                request_spec={'request': 'spec'}, filter_properties=[],
                ...
                security_groups=None,
                block_device_mapping=None, node='node', limits={},
                version='3.23', patron_network=True)
    ...
    @mock.patch('patron.objects.ComputeNode.get_by_host_and_nodename')
    @mock.patch('patron.utils.is_neutron', return_value=True)
