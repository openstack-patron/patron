...
from patron.compute import cells_api as compute_cells_api
...
class _ComputeAPIUnitTestMixIn(object):
    ...
    def _test_snapshot_and_backup(self, is_snapshot=True,
        ...
        # 'cache_in_patron' is for testing non-inheritable properties
        ...
        fake_sys_meta = dict(image_foo='bar', blah='bug?',
                             image_cache_in_patron='dropped',
                             cache_in_patron='dropped',
                             user_id='meow')
        if with_base_ref:
        ...
        expected_sys_meta.pop('cache_in_patron')
        expected_sys_meta.pop('image_cache_in_patron')
    ...
    @mock.patch('patron.objects.Quotas.commit')
    @mock.patch('patron.objects.Quotas.reserve')
    @mock.patch('patron.objects.Instance.save')
    @mock.patch('patron.objects.InstanceAction.action_start')
...
class SecurityGroupAPITest(test.NoDBTestCase):
    ...
    @mock.patch('patron.objects.security_group.SecurityGroupList.'
                'get_by_instance')
