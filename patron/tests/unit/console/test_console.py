...
from patron.console import api as console_api
from patron.console import rpcapi as console_rpcapi
...
CONF = cfg.CONF
CONF.import_opt('console_manager', 'patron.service')
CONF.import_opt('console_driver', 'patron.console.manager')
