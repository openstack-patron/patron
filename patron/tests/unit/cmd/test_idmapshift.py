...
from patron.cmd import idmapshift
...
class ShiftPathTestCase(BaseTestCase):
    ...
    @mock.patch('os.lchown')
    @mock.patch('patron.cmd.idmapshift.print_chown')
    @mock.patch('os.lstat')
...
class ShiftDirTestCase(BaseTestCase):
    @mock.patch('patron.cmd.idmapshift.shift_path')
...
class ConfirmDirTestCase(BaseTestCase):
    ...
    @mock.patch('patron.cmd.idmapshift.confirm_path')
    @mock.patch('os.path.join')
    @mock.patch('os.walk')
...
class MainTestCase(BaseTestCase):
    @mock.patch('patron.cmd.idmapshift.shift_dir')
    ...
    @mock.patch('patron.cmd.idmapshift.shift_dir')
    @mock.patch('patron.cmd.idmapshift.confirm_dir')
    @mock.patch('argparse.ArgumentParser')
