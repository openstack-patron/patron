...
from patron.cells import driver
from patron.cells import manager as cells_manager
...
def init(test_case):
    ...
    test_case.flags(driver='patron.tests.unit.cells.fakes.FakeCellsDriver',
            group='cells')
    CELL_NAME_TO_STUB_INFO = {}
