...
from patron.cells import filters
from patron.cells import weights
...
from patron.tests.unit.cells import fakes
from patron.tests.unit import fake_block_device
from patron import utils

CONF = cfg.CONF
CONF.import_opt('scheduler_retries', 'patron.cells.scheduler', group='cells')
CONF.import_opt('scheduler_filter_classes', 'patron.cells.scheduler',
                group='cells')
CONF.import_opt('scheduler_weight_classes', 'patron.cells.scheduler',
                group='cells')
...
class CellsSchedulerTestCase(test.TestCase):
    ...
    def test_cells_filter_args_correct(self):
        ...
        our_path = 'patron.tests.unit.cells.test_cells_scheduler'
