...
from patron.objects import fields as objects_fields
...
class CellsTargetedMethodsTestCase(test.TestCase):
    ...
    def test_service_update(self):
        ...
        objects.Service.get_by_args(
            self.ctxt, 'fake_host', 'patron-compute').AndReturn(fake_service)
        fake_service.save()
        self.mox.ReplayAll()
    ...
    def test_service_delete(self):
        fake_service = dict(id=42, host='fake_host', binary='patron-compute',
                            topic='compute')
