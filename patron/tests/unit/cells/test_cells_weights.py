...
from patron.cells import state
...
class RAMByInstanceTypeWeigherTestClass(_WeigherTestClass):
    ...
    weigher_cls_name = ('patron.cells.weights.ram_by_instance_type.'
...
class WeightOffsetWeigherTestClass(_WeigherTestClass):
    ...
    weigher_cls_name = 'patron.cells.weights.weight_offset.WeightOffsetWeigher'
...
class MuteWeigherTestClass(_WeigherTestClass):
    weigher_cls_name = 'patron.cells.weights.mute_child.MuteChildWeigher'
