...
from patron.api.openstack.compute import ips
...
from patron.tests.unit.objects import test_keypair
...
class ServersControllerTest(ControllerTest):
    ...
    @mock.patch('patron.compute.api.API.get_all')
...
class ServersControllerCreateTest(test.TestCase):
    ...
    @mock.patch('patron.compute.api.API.create',
