...
from patron.api.openstack.compute.contrib import instance_usage_audit_log as ial
from patron.api.openstack.compute.plugins.v3 import instance_usage_audit_log as \
    v21_ial
