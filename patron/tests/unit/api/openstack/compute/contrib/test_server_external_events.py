...
from patron.api.openstack.compute.contrib import server_external_events \
                                                 as server_external_events_v2
from patron.api.openstack.compute.plugins.v3 import server_external_events \
...
@mock.patch('patron.objects.instance.Instance.get_by_uuid', fake_get_by_uuid)
