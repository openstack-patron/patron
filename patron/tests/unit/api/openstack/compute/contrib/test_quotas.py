...
from patron.api.openstack.compute.contrib import quotas as quotas_v2
from patron.api.openstack.compute.plugins.v3 import quota_sets as quotas_v21
...
class QuotaSetsTestV21(BaseQuotaSetsTest):
    ...
    @mock.patch('patron.objects.Quotas.create_limit')
    ...
    @mock.patch('patron.api.validation.validators._SchemaValidator.validate')
    @mock.patch('patron.objects.Quotas.create_limit')
    ...
    def test_quotas_delete_as_admin(self):
        ...
        self.req.environ['patron.context'] = context
