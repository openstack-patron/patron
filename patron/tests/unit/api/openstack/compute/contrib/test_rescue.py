...
from patron.api.openstack.compute.contrib import rescue as rescue_v2
from patron.api.openstack.compute.plugins.v3 import rescue as rescue_v21
...
class RescueTestV21(test.NoDBTestCase):
    ...
    @mock.patch('patron.compute.api.API.rescue')
