...
from patron.api.openstack.compute.contrib import cloudpipe as cloudpipe_v2
from patron.api.openstack.compute.plugins.v3 import cloudpipe as cloudpipe_v21
