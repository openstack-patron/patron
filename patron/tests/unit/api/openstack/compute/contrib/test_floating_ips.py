...
from patron.api.openstack.compute.contrib import floating_ips as fips_v2
from patron.api.openstack.compute.plugins.v3 import floating_ips as fips_v21
...
def network_api_get_floating_ip(self, context, id):
    return {'id': 1, 'address': '10.10.10.10', 'pool': 'patron',
            'fixed_ip_id': None}
...
class FloatingIpTestV21(test.TestCase):
    ...
    def _create_floating_ips(self, floating_ips=None):
        ...
        dict_ = {'pool': 'patron', 'host': 'fake_host'}
    ...
    def test_translate_floating_ip_view_dict(self):
        floating_ip = {'id': 0, 'address': '10.0.0.10', 'pool': 'patron',
                       'fixed_ip': None}
        view = self.floating_ips._translate_floating_ip_view(floating_ip)
        self.assertIn('floating_ip', view)
    ...
    @mock.patch('patron.network.api.API.allocate_floating_ip',
