...
from patron.api.openstack.compute.contrib import services as services_v2
from patron.api.openstack.compute.plugins.v3 import services as services_v21
...
class FakeRequestWithHostService(object):
        environ = {"patron.context": context.get_admin_context()}
        GET = {"host": "host1", "binary": "patron-compute"}
...
class ServicesTestV21(test.TestCase):
    ...
    def test_services_enable(self):
        ...
        body = {'host': 'host1', 'binary': 'patron-compute'}
    ...
    def test_services_enable_with_invalid_host(self):
        body = {'host': 'invalid', 'binary': 'patron-compute'}
    ...
    def test_services_delete(self):
        ...
        with mock.patch.object(self.controller.host_api,
            ...
            service_delete.assert_called_once_with(
                self.req.environ['patron.context'], '1')
