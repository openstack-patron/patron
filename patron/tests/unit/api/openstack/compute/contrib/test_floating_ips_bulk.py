...
from patron.api.openstack.compute.contrib import floating_ips_bulk as fipbulk_v2
from patron.api.openstack.compute.plugins.v3 import floating_ips_bulk as\
                                                      fipbulk_v21
...
class FloatingIPBulkV21(test.TestCase):
    ...
    @mock.patch('patron.objects.FloatingIPList.get_all')
