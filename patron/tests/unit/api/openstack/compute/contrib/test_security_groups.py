...
from patron.api.openstack.compute.contrib import security_groups as secgroups_v2
from patron.api.openstack.compute.plugins.v3 import security_groups as \
    secgroups_v21
from patron import compute
from patron.compute import power_state
from patron import context as context_maker
import patron.db
...
class TestSecurityGroupsV21(test.TestCase):
    ...
    def test_create_security_group_with_no_name(self):
        ...
        self._assert_no_security_groups_reserved(req.environ['patron.context'])
    ...
    def test_get_security_group_list(self):
        ...
        self.stubs.Set(patron.db, 'security_group_get_by_project',
    ...
    def test_get_security_group_list_all_tenants(self):
        ...
        self.stubs.Set(patron.db, 'security_group_get_all',
    ...
    def test_get_security_group_by_instance(self):
        ...
        self.stubs.Set(patron.db, 'security_group_get_by_instance',
                       return_security_groups)
    ...
    @mock.patch('patron.db.security_group_get_by_instance', return_value=[])
    def test_get_security_group_empty_for_instance(self, mock_sec_group,
        ...
        mock_sec_group.assert_called_once_with(req.environ['patron.context'],
                                               FAKE_UUID1)

    def test_get_security_group_by_instance_non_existing(self):
        self.stubs.Set(patron.db, 'instance_get', return_server_nonexistent)
        self.stubs.Set(patron.db, 'instance_get_by_uuid',
    ...
    def test_get_security_group_by_id(self):
        ...
        self.stubs.Set(patron.db, 'security_group_get',
    ...
    def test_update_security_group(self):
        ...
        self.stubs.Set(patron.db, 'security_group_update',
    ...
    def test_delete_security_group_by_id(self):
        ...
        self.stubs.Set(patron.db, 'security_group_destroy',
    ...
    def test_delete_security_group_in_use(self):
        ...
        self.stubs.Set(patron.db, 'security_group_in_use',
    ...
    def test_associate_by_non_existing_security_group_name(self):
        self.stubs.Set(patron.db, 'instance_get', return_server)
        self.assertEqual(return_server(None, '1'),
                         patron.db.instance_get(None, '1'))
    ...
    def test_associate_non_running_instance(self):
        self.stubs.Set(patron.db, 'instance_get', return_non_running_server)
        self.stubs.Set(patron.db, 'instance_get_by_uuid',
                       return_non_running_server)
        self.stubs.Set(patron.db, 'security_group_get_by_name',
    ...
    def test_associate(self):
        ...
        self.stubs.Set(patron.db, 'instance_get_by_uuid',
                       return_server_by_uuid)
        self.mox.StubOutWithMock(patron.db, 'instance_add_security_group')
        patron.db.instance_add_security_group(mox.IgnoreArg(),
                                            mox.IgnoreArg(),
                                            mox.IgnoreArg())
        self.stubs.Set(patron.db, 'security_group_get_by_name',
                       return_security_group_without_instances)
    ...
    def test_disassociate(self):
        ...
        self.stubs.Set(patron.db, 'instance_get_by_uuid',
                       return_server_by_uuid)
        self.mox.StubOutWithMock(patron.db, 'instance_remove_security_group')
        patron.db.instance_remove_security_group(mox.IgnoreArg(),
                                    mox.IgnoreArg(),
                                    mox.IgnoreArg())
        self.stubs.Set(patron.db, 'security_group_get_by_name',
                       return_security_group_by_name)
...
class TestSecurityGroupRulesV21(test.TestCase):
    ...
    def test_delete(self):
        ...
        self.stubs.Set(patron.db, 'security_group_rule_get',
                       security_group_rule_get)
        self.stubs.Set(patron.db, 'security_group_rule_destroy',
