...
from patron.api.openstack.compute.contrib import aggregates as aggregates_v2
from patron.api.openstack.compute.plugins.v3 import aggregates as aggregates_v21
...
AGGREGATE_LIST = [
        {"name": "aggregate1", "id": "1", "availability_zone": "patron1"},
        {"name": "aggregate2", "id": "2", "availability_zone": "patron1"},
        {"name": "aggregate3", "id": "3", "availability_zone": "patron2"},
        {"name": "aggregate1", "id": "4", "availability_zone": "patron1"}]
...
class FakeRequest(object):
    environ = {"patron.context": context.get_admin_context()}
...
class AggregateTestCaseV21(test.NoDBTestCase):
    ...
    def test_create(self):
        def stub_create_aggregate(context, name, availability_zone):
            ...
            self.assertEqual("patron1", availability_zone, "availability_zone")
            return AGGREGATE
    ...
    def test_update_no_admin(self):
        body = {"aggregate": {"availability_zone": "patron"}}
        self.assertRaises(exception.PolicyNotAuthorized,
    ...
    def test_update_with_only_availability_zone(self):
        body = {"aggregate": {"availability_zone": "patron1"}}
