...
from patron.api.openstack.compute.contrib import floating_ip_dns as fipdns_v2
from patron.api.openstack.compute.plugins.v3 import floating_ip_dns as \
                                                        fipdns_v21
...
def _quote_domain(domain):
    ...
    python-patronclient/patronclient/v1_1/floating_ip_dns.py
    """
