...
from patron.api.openstack.compute.contrib import admin_actions as \
    migrate_server_v2
from patron.api.openstack.compute.plugins.v3 import migrate_server as \
    migrate_server_v21
from patron import exception
from patron import test
from patron.tests.unit.api.openstack.compute import admin_only_action_common
...
class MigrateServerTestsV21(admin_only_action_common.CommonTests):
    ...
    def test_migrate_live_migration_with_old_patron_not_safe(self):
        self._test_migrate_live_failed_with_exception(
