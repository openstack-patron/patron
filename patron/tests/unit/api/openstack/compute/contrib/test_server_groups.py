...
from patron.api.openstack.compute.contrib import server_groups
from patron.api.openstack.compute.plugins.v3 import server_groups as sg_v21
...
class ServerGroupTestV21(test.TestCase):
    ...
    def test_list_server_group_by_tenant(self):
        ...
        self.stubs.Set(patron.db, 'instance_group_get_all_by_project_id',
    ...
    def test_list_server_group_all(self):
        ...
        self.stubs.Set(patron.db, 'instance_group_get_all',
    ...
    def test_delete_server_group_by_id(self):
        ...
        self.stubs.Set(patron.db, 'instance_group_delete',
                       server_group_delete)
        self.stubs.Set(patron.db, 'instance_group_get',
                       return_server_group)
