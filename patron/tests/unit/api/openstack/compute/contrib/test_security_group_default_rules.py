...
from patron.api.openstack.compute.contrib import \
    security_group_default_rules as security_group_default_rules_v2
from patron.api.openstack.compute.plugins.v3 import \
...
class TestSecurityGroupDefaultRulesV21(test.TestCase):
    ...
    @mock.patch('patron.db.security_group_default_rule_list',
    ...
    @mock.patch('patron.db.security_group_default_rule_get',
                side_effect=(exception.
                    SecurityGroupDefaultRuleNotFound("Rule Not Found")))
    ...
    def test_delete_security_group_default_rule(self):
        ...
        self.stubs.Set(patron.db, 'security_group_default_rule_destroy',
                       security_group_default_rule_destroy)
        self.stubs.Set(patron.db, 'security_group_default_rule_get',
    ...
    @mock.patch('patron.db.security_group_default_rule_destroy',
                side_effect=(exception.
                    SecurityGroupDefaultRuleNotFound("Rule Not Found")))
    ...
    def test_security_group_ensure_default(self):
        ...
        sg = patron.db.security_group_ensure_default(ctxt)
        rules = patron.db.security_group_rule_get_by_security_group(ctxt, sg.id)
