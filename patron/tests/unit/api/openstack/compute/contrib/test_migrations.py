...
from patron.api.openstack.compute.contrib import migrations as migrations_v2
from patron.api.openstack.compute.plugins.v3 import migrations as migrations_v21
...
class FakeRequest(object):
    environ = {"patron.context": context.RequestContext('fake_user', 'fake',
                                                      is_admin=True)}
    GET = {}
...
class MigrationsTestCaseV2(MigrationsTestCaseV21):
    ...
    def test_index_needs_authorization(self):
        user_context = context.RequestContext(user_id=None,
                                              ...
                                              read_deleted="no",
                                              overwrite=False)
        self.req.environ['patron.context'] = user_context
