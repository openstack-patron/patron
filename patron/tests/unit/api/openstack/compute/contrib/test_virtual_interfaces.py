...
from patron.api.openstack.compute.contrib import virtual_interfaces as vi20
from patron.api.openstack.compute.plugins.v3 import virtual_interfaces as vi21
