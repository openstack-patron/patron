...
from patron.api.openstack.compute.contrib import baremetal_nodes as b_nodes_v2
from patron.api.openstack.compute.plugins.v3 import baremetal_nodes \
                                                 as b_nodes_v21
...
class FakeRequest(object):
    ...
    def __init__(self, context):
        self.environ = {"patron.context": context}
