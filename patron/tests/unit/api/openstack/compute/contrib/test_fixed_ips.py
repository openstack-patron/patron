...
from patron.api.openstack.compute.contrib import fixed_ips as fixed_ips_v2
from patron.api.openstack.compute.plugins.v3 import fixed_ips as fixed_ips_v21
