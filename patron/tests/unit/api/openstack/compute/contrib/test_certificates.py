...
from patron.api.openstack.compute.contrib import certificates as certificates_v2
from patron.api.openstack.compute.plugins.v3 import certificates \
    as certificates_v21
from patron.cert import rpcapi
