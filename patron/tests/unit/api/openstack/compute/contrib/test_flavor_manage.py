...
from patron.api.openstack.compute.contrib import flavor_access as \
    flavor_access_v2
from patron.api.openstack.compute.contrib import flavormanage as flavormanage_v2
from patron.api.openstack.compute.plugins.v3 import flavor_access as \
    flavor_access_v21
from patron.api.openstack.compute.plugins.v3 import flavor_manage as \
    flavormanage_v21
...
class FlavorManageTestV21(test.NoDBTestCase):
    ...
    @mock.patch('patron.compute.flavors.create',
