...
from patron.api.openstack.compute.contrib import flavorextraspecs \
 as flavorextraspecs_v2
from patron.api.openstack.compute.plugins.v3 import flavors_extraspecs \
...
class FlavorsExtraSpecsTestV21(test.TestCase):
    ...
    def test_index_no_data(self):
        self.stubs.Set(patron.db, 'flavor_extra_specs_get',
    ...
    def test_delete(self):
        flavor = dict(test_flavor.fake_flavor,
                      extra_specs={'key5': 'value5'})
        self.stubs.Set(patron.db, 'flavor_extra_specs_delete',
    ...
    @mock.patch('patron.db.flavor_extra_specs_update_or_create')
