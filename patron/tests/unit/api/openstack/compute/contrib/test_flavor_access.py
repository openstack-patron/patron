...
from patron.api.openstack.compute.contrib import flavor_access \
    as flavor_access_v2
from patron.api.openstack.compute import flavors as flavors_api
from patron.api.openstack.compute.plugins.v3 import flavor_access \
...
class FlavorAccessTestV21(test.NoDBTestCase):
    ...
    def setUp(self):
        ...
        self.req.environ = {"patron.context": context.RequestContext('fake_user',
                                                                   'fake')}
    ...
    def test_list_flavor_with_admin_default_proj1(self):
        ...
        req.environ['patron.context'].project_id = 'proj1'
    ...
    def test_list_flavor_with_admin_default_proj2(self):
        ...
        req = fakes.HTTPRequest.blank(self._prefix + '/flavors',
                                      use_admin_context=True)
        req.environ['patron.context'].project_id = 'proj2'
        result = self.flavor_controller.index(req)
        self._verify_flavor_list(result['flavors'], expected['flavors'])
...
class FlavorAccessTestV20(FlavorAccessTestV21):
    ...
    def setUp(self):
        ...
        self.req = FakeRequest()
        self.req.environ = {"patron.context": context.get_admin_context()}
