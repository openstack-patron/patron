...
from patron.api.openstack.compute.contrib import hosts as os_hosts_v2
from patron.api.openstack.compute.plugins.v3 import hosts as os_hosts_v21
...
from patron.tests.unit import fake_hosts
...
class FakeRequestWithNovaZone(object):
    environ = {"patron.context": context_maker.get_admin_context()}
    GET = {"zone": "patron"}
...
class HostTestCaseV21(test.TestCase):
    ...
    def test_host_status_bad_host(self):
        ...
        self.req.environ["patron.context"].is_admin = True
        dest = 'dummydest'
    ...
    def test_show_forbidden(self):
        self.req.environ["patron.context"].is_admin = False
        dest = 'dummydest'
