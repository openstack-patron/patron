...
from patron.api.openstack.compute.contrib import cells as cells_ext_v2
from patron.api.openstack.compute.plugins.v3 import cells as cells_ext_v21
...
class CellsTestV21(BaseCellsTest):
    ...
    def test_cell_delete_fails_for_invalid_policy(self):
        ...
        req = self._get_request("cells/cell999")
        req.environ['patron.context'] = self.context
        req.environ["patron.context"].is_admin = False
