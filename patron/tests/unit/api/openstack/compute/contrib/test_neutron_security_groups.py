...
from patron.api.openstack.compute.contrib import security_groups
...
from patron.network.security_group import neutron_driver
from patron.objects import instance as instance_obj
from patron import test
from patron.tests.unit.api.openstack.compute.contrib import test_security_groups
...
class TestNeutronSecurityGroupsV21(
    ...
    def test_delete_security_group_in_use(self):
        ...
        with mock.patch.object(patron.db, 'instance_get_by_uuid',
    ...
    def test_associate(self):
        ...
        self.stubs.Set(patron.db, 'instance_get',
    ...
    @mock.patch('patron.network.security_group.neutron_driver.SecurityGroupAPI.'
