...
from patron.api.openstack.compute import consoles as consoles_v2
from patron.api.openstack.compute.plugins.v3 import consoles as consoles_v21
from patron.compute import vm_states
from patron import console
