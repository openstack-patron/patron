...
from patron.api.openstack.compute.plugins.v3 import limits as limits_v21
...
class BaseLimitTestSuite(test.NoDBTestCase):
    ...
    def setUp(self):
        ...
        self.stubs.Set(patron.quota.QUOTAS, "get_project_quotas",
...
class LimitsControllerTestV21(BaseLimitTestSuite):
    ...
    def _get_index_request(self, accept_header="application/json",
        ...
        context = patron.context.RequestContext('testuser', 'testproject')
        request.environ["patron.context"] = context
        return request
    ...
    def _populate_limits(self, request):
        ...
        request.environ["patron.limits"] = _limits
        return request
    ...
    def _test_index_json(self, tenant_id=None):
        ...
        with mock.patch('patron.quota.QUOTAS.get_project_quotas') as \
                get_project_quotas:
