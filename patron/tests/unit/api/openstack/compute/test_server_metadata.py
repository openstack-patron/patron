...
from patron.api.openstack.compute.plugins.v3 import server_metadata \
    as server_metadata_v21
from patron.api.openstack.compute import server_metadata as server_metadata_v2
...
class BadStateServerMetaDataTestV21(test.TestCase):
    ...
    @mock.patch.object(patron.compute.api.API, 'update_instance_metadata',
