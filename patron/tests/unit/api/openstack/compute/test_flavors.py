...
from patron.api.openstack.compute import flavors as flavors_v2
from patron.api.openstack.compute.plugins.v3 import flavors as flavors_v21
import patron.compute.flavors
...
class FlavorsTestV21(test.TestCase):
    ...
    def setUp(self):
        ...
        self.stubs.Set(patron.compute.flavors, "get_all_flavors_sorted_list",
                       fake_get_all_flavors_sorted_list)
        self.stubs.Set(patron.compute.flavors,
