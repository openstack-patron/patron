...
class MicroversionsTest(test.NoDBTestCase):
    ...
    @mock.patch("patron.api.openstack.APIRouterV21.api_extension_namespace",
                return_value='patron.api.v3.test_extensions')
    ...
    @mock.patch("patron.api.openstack.api_version_request.max_api_version")
    @mock.patch("patron.api.openstack.APIRouterV21.api_extension_namespace",
                return_value='patron.api.v3.test_extensions')
