...
class LimiterTest(test.NoDBTestCase):
    """Unit tests for the `patron.api.openstack.common.limited` method which
...
class PaginationParamsTest(test.NoDBTestCase):
    """Unit tests for the `patron.api.openstack.common.get_pagination_params`
...
class TestCollectionLinks(test.NoDBTestCase):
    ...
    @mock.patch('patron.api.openstack.common.ViewBuilder._get_next_link')
