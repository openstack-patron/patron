...
from patron.api import auth as api_auth
from patron.api import openstack as openstack_api
from patron.api.openstack import api_version_request as api_version
from patron.api.openstack import auth
from patron.api.openstack import compute
from patron.api.openstack.compute import limits
from patron.api.openstack.compute import versions
from patron.api.openstack import urlmap
from patron.api.openstack import wsgi as os_wsgi
...
def stub_out_key_pair_funcs(stubs, have_key_pair=True, **kwargs):
    ...
    if have_key_pair:
        stubs.Set(patron.db, 'key_pair_get_all_by_user', key_pair)
        stubs.Set(patron.db, 'key_pair_get', one_key_pair)
    else:
        stubs.Set(patron.db, 'key_pair_get_all_by_user', no_key_pair)
...
def stub_out_rate_limiting(stubs):
    ...
    stubs.Set(patron.api.openstack.compute.limits.RateLimitingMiddleware,
