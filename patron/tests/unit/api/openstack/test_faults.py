...
class TestFaultWrapper(test.NoDBTestCase):
    """Tests covering `patron.api.openstack:FaultWrapper` class."""

    @mock.patch('oslo_i18n.translate')
    @mock.patch('patron.i18n.get_available_languages')
...
class TestFaults(test.NoDBTestCase):
    """Tests covering `patron.api.openstack.faults:Fault` class."""
