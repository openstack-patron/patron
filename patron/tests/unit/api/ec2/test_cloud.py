...
from patron.api.ec2 import cloud
from patron.api.ec2 import ec2utils
from patron.api.ec2 import inst_state
...
from patron.image import s3
from patron.network import api as network_api
from patron.network import base_api as base_network_api
...
from patron.tests.unit.api.openstack.compute.contrib import (
...
from patron.virt import fake as fake_virt
from patron import volume

CONF = cfg.CONF
CONF.import_opt('compute_driver', 'patron.virt.driver')
CONF.import_opt('default_flavor', 'patron.compute.flavors')
...
class CloudTestCase(test.TestCase):
    ...
    def setUp(self):
        ...
        self.flags(compute_driver='patron.virt.fake.FakeDriver',
                   volume_api_class='patron.tests.unit.fake_volume.API')
        ...
        self.flags(scheduler_driver='patron.scheduler.chance.ChanceScheduler')
    ...
    def test_describe_addresses(self):
        ...
        db.floating_ip_create(self.context,
                              {'address': address,
                               'pool': 'patron'})
        self.flags(network_api_class='patron.network.api.API')
