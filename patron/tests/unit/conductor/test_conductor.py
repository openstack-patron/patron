...
from patron.api.ec2 import ec2utils
...
from patron.conductor.tasks import live_migrate
from patron import context
from patron import db
from patron.db.sqlalchemy import models
from patron import exception as exc
from patron.image import api as image_api
...
from patron.scheduler import utils as scheduler_utils
from patron import test
from patron.tests.unit import cast_as_call
from patron.tests.unit.compute import test_compute
...
CONF = cfg.CONF
CONF.import_opt('report_interval', 'patron.service')
...
class ConductorRPCAPITestCase(_BaseTestCase, test.TestCase):
    ...
    def setUp(self):
        ...
        self.conductor_service = self.start_service(
            'conductor', manager='patron.conductor.manager.ConductorManager')
...
class ConductorPolicyTest(test.TestCase):
    def test_all_allowed_keys(self):
        ...
        with mock.patch('patron.objects.Instance._from_db_object'):
...
class _BaseTaskTestCase(object):
    ...
    @mock.patch('patron.objects.Instance.refresh')
    ...
    def test_unshelve_instance_schedule_and_rebuild_patronlid_host(self):
        instance = self._create_fake_instance_obj()
        instance.vm_state = vm_states.SHELVED_OFFLOADED
        instance.save()
        system_metadata = instance.system_metadata
    ...
    def test_rebuild_instance_with_scheduler(self):
        ...
        with contextlib.nested(
            ...
            mock.patch('patron.scheduler.utils.build_request_spec',
