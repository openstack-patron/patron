...
from patron.api.metadata import base
from patron.api.metadata import handler
...
from patron.db.sqlalchemy import api
...
class MetadataHandlerTestCase(test.TestCase):
    ...
    @mock.patch('patron.utils.constant_time_compare')
