...
from patron.pci import manager
...
class PciDevTrackerTestCase(test.NoDBTestCase):
    ...
    @mock.patch.object(patron.objects.PciDeviceList, 'get_by_compute_node')
    ...
    @mock.patch('patron.objects.InstancePCIRequests.get_by_instance')
