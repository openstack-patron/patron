...
class TenantNetworksJsonTests(api_sample_base.ApiSampleTestBaseV3):
    ...
    def setUp(self):
        ...
        self.stubs.Set(patron.quota.QUOTAS, "reserve", fake)
        self.stubs.Set(patron.quota.QUOTAS, "commit", fake)
        self.stubs.Set(patron.quota.QUOTAS, "rollback", fake)
        self.stubs.Set(patron.quota.QuotaEngine, "reserve", fake)
        self.stubs.Set(patron.quota.QuotaEngine, "commit", fake)
        self.stubs.Set(patron.quota.QuotaEngine, "rollback", fake)
