...
from patron import exception as ex
from patron import test
from patron.tests import fixtures as patron_fixtures
from patron.tests.functional import integrated_helpers as helper
...
class FlavorManageFullstack(test.TestCase):
    ...
    This test starts the wsgi stack for the patron api services, uses an
    ...
    def setUp(self):
        ...
        api_fixture = self.useFixture(patron_fixtures.OSAPIFixture())
