...
class _IntegratedTestBase(test.TestCase):
    ...
    def setUp(self):
        ...
        self.api_fixture = self.useFixture(
            patron_fixtures.OSAPIFixture(self._api_version))
        ...
        self.addCleanup(patron.tests.unit.image.fake.FakeImageService_reset)

    def _setup_compute_service(self):
        return self.start_service('compute')

    def _setup_scheduler_service(self):
        self.flags(scheduler_driver='patron.scheduler.'
