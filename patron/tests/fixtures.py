...
from patron.db.sqlalchemy import api as session
...
class ServiceFixture(fixtures.Fixture):
    ...
    def __init__(self, name, host=None, **kwargs):
        ...
        kwargs.setdefault('binary', 'patron-%s' % name)
        self.kwargs = kwargs
...
class PoisonFunctions(fixtures.Fixture):
    ...
    def setUp(self):
        ...
        # The patron libvirt driver starts an event thread which only
        ...
        # module.
        import patron.virt.libvirt.host  # noqa
        ...
        self.useFixture(fixtures.MonkeyPatch(
            'patron.virt.libvirt.host.Host._init_events',
            evloop))
