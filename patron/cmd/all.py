...
"""Starter script for all patron services.

This script attempts to start all the patron services in one process.  Each
...
from patron.vnc import xvp_proxy


CONF = cfg.CONF
CONF.import_opt('manager', 'patron.conductor.api', group='conductor')
CONF.import_opt('topic', 'patron.conductor.api', group='conductor')
CONF.import_opt('enabled_apis', 'patron.service')
CONF.import_opt('enabled_ssl_apis', 'patron.service')
