...
scheduler_driver_opts = [
    cfg.StrOpt('scheduler_driver',
               default='patron.scheduler.filter_scheduler.FilterScheduler',
...
class SchedulerManager(manager.Manager):
    ...
    def update_aggregates(self, ctxt, aggregates):
        ...
        :type aggregates: :class:`patron.objects.Aggregate`
                          or :class:`patron.objects.AggregateList`
        """
    ...
    def delete_aggregate(self, ctxt, aggregate):
        ...
        :type aggregate: :class:`patron.objects.Aggregate`
        """
        # NOTE(sbauza): We're dropping the user context now as we don't need it
