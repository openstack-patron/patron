...
from patron import context as context_module
...
host_manager_opts = [
    cfg.MultiStrOpt('scheduler_available_filters',
            default=['patron.scheduler.filters.all_filters'],
            help='Filter classes available to the scheduler which may '
                    'be specified more than once.  An entry of '
                    '"patron.scheduler.filters.all_filters" '
                    'maps to all filters included with patron.'),
    ...
    cfg.ListOpt('scheduler_weight_classes',
                default=['patron.scheduler.weights.all_weighers'],
