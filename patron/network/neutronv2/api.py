...
CONF.import_opt('default_floating_pool', 'patron.network.floating_ips')
CONF.import_opt('flat_injected', 'patron.network.manager')
...
class API(base_api.NetworkAPI):
    ...
    def allocate_for_instance(self, context, instance, **kwargs):
        ...
        :param dhcp_options: None or a set of key/value pairs that should
            ...
            See patron/virt/driver.py:dhcp_options_for_instance for an example.
        """
    ...
    def _gather_port_ids_and_networks(self, context, instance, networks=None,
        ...
        if ((networks is None and port_ids is not None) or
            ...
            raise exception.PatronException(message=message)
    ...
    def associate_floating_ip(self, context, instance,
        ...
        # since it is not used anywhere in patron code and I could
    ...
    def get_floating_ip_pools(self, context):
        ...
        # patron.network.api.get_floating_ip_pools
    ...
    def _format_floating_ip_model(self, fip, pool_dict, port_dict):
        ...
        if fip['port_id']:
            ...
            # API methods are converted to use patron objects.
    ...
    def _get_floating_ip_pool_id_by_name_or_id(self, client, name_or_id):
        ...
        if len(nets) == 1:
            ...
            msg = (_("Multiple floating IP pools matches found for name '%s'")
                   % name_or_id)
            raise exception.PatronException(message=msg)
    ...
    def release_floating_ip(self, context, address,
        ...
        # This is a limitation of the current patron.
    ...
    def _get_preexisting_port_ids(self, instance):
        ...
        These ports were not created by patron and hence should not be
    ...
    def _build_network_info_model(self, context, instance, networks=None,
        ...
        :param preexisting_port_ids - List of port_ids that patron didn't
    ...
    def create_private_dns_domain(self, context, domain, availability_zone):
        """Create a private DNS domain with patron availability zone."""
        raise NotImplementedError()

    def create_public_dns_domain(self, context, domain, project=None):
        """Create a private DNS domain with optional patron project."""
        raise NotImplementedError()
