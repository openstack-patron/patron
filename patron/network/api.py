...
class API(base_api.NetworkAPI):
    """API for doing networking via the patron-network network manager.
    ...
    def get_all(self, context):
        ...
        networks. If it is a normal user and patron Flat or FlatDHCP
        ...
        """
        if "patron.network.manager.Flat" in CONF.network_manager:
    ...
    def create_public_dns_domain(self, context, domain, project=None):
        """Create a public DNS domain with optional patron project."""
