...
class API(object):
    ...
    attempts to match the patron.volume.api and patron.network.api calling
    interface.
    """
    ...
    def _get_session(self, _context):
        ...
        :param _context: The `patron.context.Context` object for the request
        """
    ...
    def download(self, context, id_or_uri, data=None, dest_path=None):
        ...
        :param context: The `patron.context.RequestContext` object for the
                        request
        :param id_or_uri: A UUID identifier or an image URI to look up image
                          information for.
        ...
        patron.image.download modules are used to attempt to do an SCP copy of
        ...
        Hyper-V virt drivers through patron.virt.images.fetch).
