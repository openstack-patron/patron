...
from patron.api.ec2 import apirequest
from patron.api.ec2 import ec2utils
from patron.api.ec2 import faults
from patron.api import validator
...
from patron.openstack.common import memorycache
...
CONF.import_opt('use_forwarded_for', 'patron.api.auth')
CONF.import_group('ssl', 'patron.openstack.common.sslutils')
...
class RequestLogging(wsgi.Middleware):
    ...
    def log_request_completion(self, response, request, start):
        ...
        if apireq:
            ...
            controller = None
            action = None
        ctxt = request.environ.get('patron.context', None)
...
class EC2KeystoneAuth(wsgi.Middleware):
    ...
    def __call__(self, req):
        ...
        req.environ['patron.context'] = ctxt

        return self.application


class NoAuth(wsgi.Middleware):
    """Add user:project as 'patron.context' to WSGI environ."""
...
class Executor(wsgi.Application):
    ...
    Executes 'ec2.action' upon 'ec2.controller', passing 'patron.context' and
