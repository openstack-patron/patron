...
def remove_version_from_href(href):
    ...
    Given: 'http://www.patron.com/v1.1/123'
    Returns: 'http://www.patron.com/123'

    Given: 'http://www.patron.com/v1.1'
    Returns: 'http://www.patron.com'
...
class ViewBuilder(object):
    ...
    def _get_project_id(self, request):
        ...
        otherwise
        """
        project_id = request.environ["patron.context"].project_id
