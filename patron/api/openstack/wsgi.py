...
from patron.api.openstack import versioned_method
from patron import exception
from patron import i18n
...
class Request(webob.Request):
    ...
    def best_match_content_type(self):
        ...
        if 'patron.best_content_type' not in self.environ:
            ...
            self.environ['patron.best_content_type'] = (content_type or
                                                      'application/json')

        return self.environ['patron.best_content_type']
...
class Resource(wsgi.Application):
    ...
    def _process_stack(self, request, action, action_args,
        ...
        context = request.environ.get('patron.context')
