...
class ExtensionManager(object):
    ...
    See patron/tests/api/openstack/compute/extensions/foxinsocks.py or an
...
class ControllerExtension(object):
    """Extend core controllers of patron OpenStack API.

    Provide a way to extend existing patron OpenStack API core
    controllers.
    """
...
class ResourceExtension(object):
    """Add top level resources to the OpenStack API in patron."""
...
def core_authorizer(api_name, extension_name):
    def authorize(context, target=None, action=None):
        ...
        patron.policy.enforce(context, act, target)
    return authorize
