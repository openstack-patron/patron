...
from patron.api.openstack.compute.schemas.v3 import block_device_mapping_v1
from patron.api.validation import parameter_types


block_device_mapping_new_item = {
    # defined in patron/block_device.py:from_api()
    ...
    # Defined as integer in patron/block_device.py:from_api()
    'boot_index': {
        'type': ['integer', 'string'],
        'pattern': '^-?[0-9]+$',
    },
