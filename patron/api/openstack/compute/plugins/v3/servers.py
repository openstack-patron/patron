...
from patron.api.openstack.compute.schemas.v3 import servers as schema_servers
from patron.api.openstack.compute.views import servers as views_servers
...
CONF.import_opt('enable_instance_password',
                'patron.api.openstack.compute.servers')
CONF.import_opt('network_api_class', 'patron.network')
CONF.import_opt('reclaim_instance_interval', 'patron.compute.manager')
CONF.import_opt('extensions_blacklist', 'patron.api.openstack', group='osapi_v3')
CONF.import_opt('extensions_whitelist', 'patron.api.openstack', group='osapi_v3')
...
class ServersController(wsgi.Controller):
    ...
    EXTENSION_CREATE_NAMESPACE = 'patron.api.v3.extensions.server.create'
    EXTENSION_DESERIALIZE_EXTRACT_SERVER_NAMESPACE = (
        'patron.api.v3.extensions.server.create.deserialize')

    EXTENSION_REBUILD_NAMESPACE = 'patron.api.v3.extensions.server.rebuild'
    EXTENSION_DESERIALIZE_EXTRACT_REBUILD_NAMESPACE = (
        'patron.api.v3.extensions.server.rebuild.deserialize')

    EXTENSION_UPDATE_NAMESPACE = 'patron.api.v3.extensions.server.update'

    EXTENSION_RESIZE_NAMESPACE = 'patron.api.v3.extensions.server.resize'
    ...
    def delete(self, req, id):
        """Destroys a server."""
        try:
            self._delete(req.environ['patron.context'], req, id)
        except exception.InstanceNotFound:
            msg = _("Instance could not be found")
            raise exc.HTTPNotFound(explanation=msg)
        except exception.InstanceIsLocked as e:
    ...
    def _image_uuid_from_href(self, image_href):
        # If the image href was generated by patron api, strip image_href
