...
from patron.api.openstack.compute.views import addresses as views_addresses
from patron.api.openstack.compute.views import flavors as views_flavors
from patron.api.openstack.compute.views import images as views_images
...
class ViewBuilderV3(ViewBuilder):
    ...
    def __init__(self):
        ...
        # use glance endpoint. We revert back it to use patron endpoint for v2.1.
        self._image_builder = views_images.ViewBuilder()
