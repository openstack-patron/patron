...
import patron.api.openstack
from patron.api.openstack.compute import consoles
from patron.api.openstack.compute import extensions
from patron.api.openstack.compute import flavors
from patron.api.openstack.compute import image_metadata
...
from patron.api.openstack.compute import server_metadata
...
class APIRouter(patron.api.openstack.APIRouter):
...
class APIRouterV21(patron.api.openstack.APIRouterV21):
    """Routes requests on the OpenStack API to the appropriate controller
    and method.
    """
...
class APIRouterV3(patron.api.openstack.APIRouterV21):
    """Routes requests on the OpenStack API to the appropriate controller
    and method.
    """
    def __init__(self, init_only=None):
