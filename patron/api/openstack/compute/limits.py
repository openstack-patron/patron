...
class LimitsController(object):
    ...
    def index(self, req):
        ...
        rate_limits = req.environ.get("patron.limits", [])
...
class RateLimitingMiddleware(base_wsgi.Middleware):
    ...
    def __call__(self, req):
        ...
        verb = req.method
        url = req.url
        context = req.environ.get("patron.context")
        ...
        req.environ["patron.limits"] = self._limiter.get_limits(username)
