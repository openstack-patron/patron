...
from patron import availability_zones as az
...
metadata_opts = [
    ...
    cfg.StrOpt('vendordata_driver',
               default='patron.api.metadata.vendordata_json.JsonFileVendorData',
               help='Driver to use for vendor data'),
]

CONF = cfg.CONF
CONF.register_opts(metadata_opts)
CONF.import_opt('dhcp_domain', 'patron.network.manager')
