...
cell_scheduler_opts = [
        cfg.ListOpt('scheduler_filter_classes',
                default=['patron.cells.filters.all_filters'],
                help='Filter classes the cells scheduler should use.  '
                        'An entry of "patron.cells.filters.all_filters" '
                        'maps to all cells filters included with patron.'),
        cfg.ListOpt('scheduler_weight_classes',
                default=['patron.cells.weights.all_weighers'],
                help='Weigher classes the cells scheduler should use.  '
                        'An entry of "patron.cells.weights.all_weighers" '
                        'maps to all cell weighers included with patron.'),
