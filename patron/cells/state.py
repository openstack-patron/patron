...
from patron.cells import rpc_driver
...
CONF.import_opt('reserve_percent', 'patron.cells.opts', group='cells')
CONF.import_opt('mute_child_interval', 'patron.cells.opts', group='cells')
