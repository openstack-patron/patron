...
class TestCase(testtools.TestCase):
    ...
    def setUp(self):
        ...
        self.useFixture(patron_fixtures.Timeout(
        ...
        self.useFixture(patron_fixtures.OutputStreamCapture())

        self.useFixture(patron_fixtures.StandardLogging())
        ...
        self.useFixture(patron_fixtures.RPCFixture('patron.test'))

        if self.USES_DB:
            self.useFixture(patron_fixtures.Database())

        # NOTE(blk-u): WarningsFixture must be after the Database fixture
        # because sqlalchemy-migrate messes with the warnings filters.
        self.useFixture(patron_fixtures.WarningsFixture())
        ...
        # patron.utils._IS_NEUTRON.  We set it to None to avoid any
        ...
        self.useFixture(patron_fixtures.PoisonFunctions())
    ...
    def start_service(self, name, host=None, **kwargs):
        svc = self.useFixture(
            patron_fixtures.ServiceFixture(name, host, **kwargs))
        return svc.service
