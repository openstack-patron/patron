...
from patron.i18n import _, _LE, _LI
...
class ComputeDriver(object):
    ...
    patron.virt layer, instances do not have human-readable names at all -- such
    ...
    Some methods here take an instance of patron.compute.service.Instance.  This
    is the data structure used by patron.compute to store details regarding an
    ...
    def rebuild(self, context, instance, image_meta, injected_files,
        ...
        :param image_meta: image object returned by patron.image.glance that
                           defines the image from which to boot this instance
        :param injected_files: User files to inject into instance.
        :param admin_password: Administrator password to set in instance.
        :param bdms: block-device-mappings to use for rebuild
        :param detach_block_devices: function to detach block devices. See
            patron.compute.manager.ComputeManager:_rebuild_default_impl for
            usage.
        :param attach_block_devices: function to attach block devices. See
            patron.compute.manager.ComputeManager:_rebuild_default_impl for
            usage.
        :param network_info:
           :py:meth:`~patron.network.manager.NetworkManager.get_instance_nw_info`
    ...
    def get_all_bw_counters(self, instances):
        ...
        :param instances: patron.objects.instance.InstanceList
        """
        raise NotImplementedError()
    ...
    def finish_migration(self, context, migration, instance, disk_info,
        ...
        :param instance: patron.objects.instance.Instance being migrated/resized
    ...
    def resume(self, context, instance, network_info, block_device_info=None):
        ...
        :param instance: patron.objects.instance.Instance being resumed
        :param network_info:
           :py:meth:`~patron.network.manager.NetworkManager.get_instance_nw_info`
        :param block_device_info: instance volume block device info
        """
    ...
    def get_instance_disk_info(self, instance,
        ...
        :param instance: patron.objects.Instance
    ...
    def refresh_provider_fw_rules(self):
        ...
        :py:meth:`patron.db.provider_fw_rule_get_all`.
    ...
    def ensure_filtering_rules_for_instance(self, instance, network_info):
        ...
        - setup_basic_filtering (for patron-basic, etc.)
        - prepare_instance_filter(for patron-instance-instance-xxx, etc.)
    ...
    def inject_file(self, instance, b64_path, b64_contents):
        ...
        The first parameter is an instance of patron.compute.service.Instance,
        ...
        can be removed from patron.compute.manager.
        """
        # TODO(Vek): Need to pass context in for access to auth_token
        raise NotImplementedError()
    ...
    def manage_image_cache(self, context, all_instances):
        ...
        :param all_instances: patron.objects.instance.InstanceList
        """
        pass
    ...
    def get_per_instance_usage(self):
        ...
        :returns: dict of  patron uuid => dict of usage info
        """
        return {}
    ...
    def instance_on_disk(self, instance):
        ...
        :param instance: patron.objects.instance.Instance to lookup
    ...
    def register_event_listener(self, callback):
        ...
        an instance of the patron.virt.event.Event class.
        """
    ...
    def emit_event(self, event):
        ...
        if not isinstance(event, virtevent.Event):
            raise ValueError(
                _("Event must be an instance of patron.virt.event.Event"))
    ...
    def volume_snapshot_create(self, context, instance, volume_id,
        ...
        :param instance: patron.objects.instance.Instance that has the volume
               attached
        :param volume_id: Volume to be snapshotted
        :param create_info: The data needed for patron to be able to attach
    ...
    def quiesce(self, context, instance, image_meta):
        ...
        other errors (e.g. agent timeout), PatronException is raised.

        :param context:  request context
        :param instance: patron.objects.instance.Instance to be quiesced
        :param image_meta: image object returned by patron.image.glance that
                           defines the image from which this instance
                           was created
        """
    ...
    def unquiesce(self, context, instance, image_meta):
        ...
        :param context:  request context
        :param instance: patron.objects.instance.Instance to be unquiesced
        :param image_meta: image object returned by patron.image.glance that
                           defines the image from which this instance
                           was created
        """
...
def load_compute_driver(virtapi, compute_driver=None):
    ...
    try:
        driver = importutils.import_object_ns('patron.virt',
                                              compute_driver,
                                              virtapi)
