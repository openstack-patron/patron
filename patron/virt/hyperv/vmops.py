...
from patron.virt.hyperv import utilsfactory
...
class VMOps(object):
    _vif_driver_class_map = {
        'patron.network.neutronv2.api.API':
        'patron.virt.hyperv.vif.HyperVNeutronVIFDriver',
        'patron.network.api.API':
        'patron.virt.hyperv.vif.HyperVNovaNetworkVIFDriver',
    }
    ...
    def restart_vm_log_writers(self):
        # Restart the VM console log writers after patron compute restarts.
