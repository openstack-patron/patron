...
from patron.virt.vmwareapi import io_util

# NOTE(mdbooth): We use use_linked_clone below, but don't have to import it
# because patron.virt.vmwareapi.driver is imported first. In fact, it is not
# possible to import it here, as patron.virt.vmwareapi.driver calls
...
class VMwareImage(object):
    ...
    def from_image(cls, image_id, image_meta=None):
        ...
        :rtype: patron.virt.vmwareapi.images.VmwareImage
        """
