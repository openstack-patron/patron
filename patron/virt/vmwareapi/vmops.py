...
from patron.i18n import _, _LE, _LI, _LW
...
from patron.virt.vmwareapi import vif as vmwarevif
...
CONF.import_opt('remove_unused_base_images', 'patron.virt.imagecache')
...
# Note(vui): See https://bugs.launchpad.net/patron/+bug/1363349
...
class VMwareVMOps(object):
    ...
    def _fetch_image_if_missing(self, context, vi):
        ...
        with lockutils.lock(str(vi.cache_image_path),
                            lock_file_prefix='patron-vmware-fetch_image'):
    ...
    def poll_rebooting_instances(self, timeout, instances):
        ...
        ctxt = patron_context.get_admin_context()
    ...
    def attach_interface(self, instance, image_meta, vif):
        ...
        with lockutils.lock(instance.uuid,
                            lock_file_prefix='patron-vmware-hot-plug'):
    ...
    def _use_disk_image_as_linked_clone(self, vm_ref, vi):
        ...
        # the copy.
        #
        # Note that the object is in a per-patron cache directory,
        # so inter-patron locking is not a concern. Consequently we
        # can safely use simple thread locks.

        with lockutils.lock(str(sized_disk_ds_loc),
                            lock_file_prefix='patron-vmware-image'):
