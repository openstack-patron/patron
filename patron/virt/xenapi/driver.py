...
from patron.virt.xenapi.client import session
...
class XenAPIDriver(driver.ComputeDriver):
    ...
    def get_all_bw_counters(self, instances):
        ...
        # we only care about VMs that correspond to a patron-managed
        # instance:
        ...
        for instance_name, counters in all_counters.iteritems():
            if instance_name in imap:
                # yes these are stats for a patron-managed vm
                # correlate the stats with the patron instance uuid:
    ...
    def check_can_live_migrate_destination(self, context, instance,
        ...
        :param instance: patron.db.sqlalchemy.models.Instance object
