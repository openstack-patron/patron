...
from patron.i18n import _LE, _LI
...
__imagebackend_opts = [
    ...
    cfg.StrOpt('hw_disk_discard',
               help='Discard option for patron managed disks (valid options '
...
CONF.import_opt('preallocate_images', 'patron.virt.driver')
...
CONF.import_opt('rbd_secret_uuid', 'patron.virt.libvirt.volume', group='libvirt')
...
class Image(object):
    ...
    def __init__(self, source_type, driver_format, is_block_dev=False):
        ...
        if (CONF.ephemeral_storage_encryption.enabled and
            ...
            raise exception.PatronException(_('Incompatible settings: '
