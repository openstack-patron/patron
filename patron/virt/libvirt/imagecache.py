...
http://wiki.openstack.org/patron-image-cache-management.
...
from patron.virt import imagecache
...
class ImageCacheManager(imagecache.ImageCacheManager):
    ...
    def _verify_checksum(self, img_id, base_file, create_if_missing=True):
        ...
        # Protect against other patron-computes performing checksums at the same
