...
from patron.compute import hv_type
...
from patron.console import serial as serial_console
...
from patron.pci import utils as pci_utils
...
from patron.virt import diagnostics
from patron.virt.disk import api as disk
from patron.virt.disk.vfs import guestfs
from patron.virt import driver
from patron.virt import firewall
...
from patron.virt.libvirt import dmcrypt
from patron.virt.libvirt import firewall as libvirt_firewall
from patron.virt.libvirt import host
from patron.virt.libvirt import imagebackend
from patron.virt.libvirt import imagecache
...
from patron.virt.libvirt import vif as libvirt_vif
from patron.virt import netutils
from patron.virt import watchdog_actions
...
CONF.import_opt('use_cow_images', 'patron.virt.driver')
CONF.import_opt('enabled', 'patron.compute.api',
                group='ephemeral_storage_encryption')
CONF.import_opt('cipher', 'patron.compute.api',
                group='ephemeral_storage_encryption')
CONF.import_opt('key_size', 'patron.compute.api',
                group='ephemeral_storage_encryption')
CONF.import_opt('live_migration_retry_count', 'patron.compute.manager')
CONF.import_opt('vncserver_proxyclient_address', 'patron.vnc')
CONF.import_opt('server_proxyclient_address', 'patron.spice', group='spice')
CONF.import_opt('vcpu_pin_set', 'patron.virt.hardware')
CONF.import_opt('vif_plugging_is_fatal', 'patron.virt.driver')
CONF.import_opt('vif_plugging_timeout', 'patron.virt.driver')
CONF.import_opt('enabled', 'patron.console.serial', group='serial_console')
CONF.import_opt('proxyclient_address', 'patron.console.serial',
                group='serial_console')
CONF.import_opt('hw_disk_discard', 'patron.virt.libvirt.imagebackend',
                group='libvirt')
CONF.import_group('workarounds', 'patron.utils')
...
libvirt_volume_drivers = [
    'iscsi=patron.virt.libvirt.volume.LibvirtISCSIVolumeDriver',
    'iser=patron.virt.libvirt.volume.LibvirtISERVolumeDriver',
    'local=patron.virt.libvirt.volume.LibvirtVolumeDriver',
    'fake=patron.virt.libvirt.volume.LibvirtFakeVolumeDriver',
    'rbd=patron.virt.libvirt.volume.LibvirtNetVolumeDriver',
    'sheepdog=patron.virt.libvirt.volume.LibvirtNetVolumeDriver',
    'nfs=patron.virt.libvirt.volume.LibvirtNFSVolumeDriver',
    'smbfs=patron.virt.libvirt.volume.LibvirtSMBFSVolumeDriver',
    'aoe=patron.virt.libvirt.volume.LibvirtAOEVolumeDriver',
    'glusterfs=patron.virt.libvirt.volume.LibvirtGlusterfsVolumeDriver',
    'fibre_channel=patron.virt.libvirt.volume.LibvirtFibreChannelVolumeDriver',
    'scality=patron.virt.libvirt.volume.LibvirtScalityVolumeDriver',
    'gpfs=patron.virt.libvirt.volume.LibvirtGPFSVolumeDriver',
    'quobyte=patron.virt.libvirt.volume.LibvirtQuobyteVolumeDriver',
]
...
class LibvirtDriver(driver.ComputeDriver):
    ...
    def _destroy(self, instance):
        ...
        def _wait_for_destroy(expected_domid):
            ...
            # see https://bugs.launchpad.net/patron/+bug/1111213 for more details
    ...
    def _cleanup_resize(self, instance, network_info):
        ...
        #                be deleted correctly with grizzly or later patron.
    ...
    def swap_volume(self, old_connection_info,
        ...
        bdm = objects.BlockDeviceMapping.get_by_volume_id(
            patron_context.get_admin_context(), volume_id)
    ...
    def _get_existing_domain_xml(self, instance, network_info,
        ...
        try:
            ...
            disk_info = blockinfo.get_disk_info(CONF.libvirt.virt_type,
                                                ...
                                                image_meta,
                                                block_device_info)
            xml = self._get_guest_xml(patron_context.get_admin_context(),
    ...
    def volume_snapshot_create(self, context, instance, volume_id,
        ...
        if create_info['type'] != 'qcow2':
            raise exception.PatronException(_('Unknown type: %s') %
                                          create_info['type'])

        snapshot_id = create_info.get('snapshot_id', None)
        if snapshot_id is None:
            raise exception.PatronException(_('snapshot_id required '
                                            'in create_info'))
    ...
    def _set_host_enabled(self, enabled,
        ...
        ctx = patron_context.get_admin_context()
        try:
    ...
    def _set_guest_for_inst_kernel(self, instance, guest, inst_path, virt_type,
        ...
        # kernel set and don't want to break patron if there's an
    ...
    def _get_guest_config(self, instance, network_info, image_meta,
        ...
        if root_device_name:
            # NOTE(yamahata):
            # for patron.api.ec2.cloud.CloudController.get_metadata()
    ...
    def get_available_resource(self, nodename):
        ...
        # See: https://bugs.launchpad.net/patron/+bug/1215593
    ...
    def check_instance_shared_storage_local(self, context, instance):
        ...
        :param context: security context
        :param instance: patron.objects.instance.Instance object
        :returns
    ...
    def check_can_live_migrate_destination(self, context, instance,
        ...
        :param context: security context
        :param instance: patron.db.sqlalchemy.models.Instance
    ...
    def _compare_cpu(self, guest_cpu, host_cpu_str):
        ...
        :param guest_cpu: patron.objects.VirtCPUModel or None
    ...
    def ensure_filtering_rules_for_instance(self, instance, network_info):
        ...
        while timeout_count:
            ...
            if len(timeout_count) == 0:
                ...
                raise exception.PatronException(msg % instance.name)
            greenthread.sleep(1)
    ...
    def live_migration(self, context, instance, dest,
        ...
        :param context: security context
        :param instance:
            patron.db.sqlalchemy.models.Instance object
            instance object that is migrated.
        :param dest: destination host
        :param post_method:
            post operation method.
            expected patron.compute.manager._post_live_migration.
        :param recover_method:
            recovery method when any exception occurs.
            expected patron.compute.manager._rollback_live_migration.
    ...
    def default_device_names_for_instance(self, instance, root_device_name,
        ...
        blockinfo.default_device_names(CONF.libvirt.virt_type,
                                       patron_context.get_admin_context(),
