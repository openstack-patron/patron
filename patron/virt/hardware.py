...
def _score_cpu_topology(topology, wanttopology):
    ...
    :param wanttopology: patron.objects.VirtCPUTopology instance for
                         preferred topology
...
def _get_cpu_topology_constraints(flavor, image_meta):
    ...
    This will return a pair of patron.objects.VirtCPUTopology instances,
...
def _get_possible_cpu_topologies(vcpus, maxtopology,
    ...
    :param maxtopology: patron.objects.VirtCPUTopology for upper limits
    ...
    list of patron.objects.VirtCPUTopology instances that represent every
    ...
    :returns: list of patron.objects.VirtCPUTopology instances
    """
...
def _sort_possible_cpu_topologies(possible, wanttopology):
    ...
    :param possible: list of patron.objects.VirtCPUTopology instances
    :param wanttopology: patron.objects.VirtCPUTopology for preferred
                         topology
    ...
    :returns: sorted list of patron.objects.VirtCPUTopology instances
    """
...
def get_best_cpu_topology(flavor, image_meta, allow_threads=True,
    ...
    :returns: a patron.objects.VirtCPUTopology instance for best topology
    """
...
def get_host_numa_usage_from_instance(host, instance, free=False,
    ...
    :param host: patron.objects.ComputeNode instance, or a db object or dict
    :param instance: patron.objects.Instance instance, or a db object or dict
