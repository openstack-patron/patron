...
from patron.virt.ironic import client_wrapper
from patron.virt.ironic import ironic_states
from patron.virt.ironic import patcher
...
class IronicDriver(virt_driver.ComputeDriver):
    ...
    def __init__(self, virtapi, read_only=False):
        ...
        self.firewall_driver = firewall.load_driver(
            default='patron.virt.firewall.NoopFirewallDriver')
        self.node_cache = {}
    ...
    def list_instances(self):
        ...
        node_list = self.ironicclient.call("node.list", associated=True,
                                           limit=0)
        context = patron_context.get_admin_context()
    ...
    def spawn(self, context, instance, image_meta, injected_files,
        ...
        :param instance: The instance object.
        :param image_meta: Image dict returned by patron.image.glance
    ...
    def rebuild(self, context, instance, image_meta, injected_files,
        ...
        :param context: The security context.
        :param instance: The instance object.
        :param image_meta: Image object returned by patron.image.glance
        ...
        except (exception.PatronException,         # Retry failed
